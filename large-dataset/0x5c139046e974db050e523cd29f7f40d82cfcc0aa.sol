...
// 3nity is a novel ERC-20 protocol that automatically generates liquidity for its native and partner pools, 

// incentivizes holders and liquidity providers with instant yields, 

// while sustaining its price through hourly market buy-backs.

// Liquidity connector for DeFi fork of Trinity

// 

// https://t.me/Protocol_3nity 

// 

//https://www.3nity.finance/

// https://twitter.com/3nityF
...
contract TRINITY is Context, IERC20, Ownable {
    ...
    string private _name = '3nity.finance';

    string private _symbol = '3NITY';
