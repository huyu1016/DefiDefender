...
contract Simpletons is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    uint256 public constant MAXASSETS = 1000;
    uint256 public constant freeMints = 80;
    ...
    constructor(string memory baseURI, address _proxyRegistryAddress) ERC721A("Simpletons", "SMPLTNS") {
        setBaseURI(baseURI);
        isSaleActive = false;
