...
// File: contracts/BigCats.sol

/*________.__         _________         __
\______   \__| ____   \_   ___ \_____ _/  |_  ______
 |    |  _/  |/ ___\  /    \  \/\__  \\   __\/  ___/
 |    |   \  / /_/  > \     \____/ __ \|  |  \___ \
 |______  /__\___  /   \______  (____  /__| /____  >
        \/  /_____/           \/     \/          \/
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
...
contract BigCats is ERC721Enumerable, Ownable {
  ...
  function mint(uint256 mintAmount) public payable {
    ...
    require(mintAmount > 0, "at least 1 bigcat");
    require(supply + mintAmount <= _maxSupply, "max bigcat limit exceeded");

    if (msg.sender != owner()) {
      require(!_paused, "sale paused");
      require(mintAmount <= _maxMintAmount, "you can adopt a maximum of 20 bigcats");
      require(msg.value >= _price * mintAmount, "insufficient funds");
    }
  ...
  function gift(uint256 amount, address destination) public onlyOwner {
    require(amount > 0, "at least 1 bigcat");
    uint256 supply = totalSupply();
    require(supply + amount <= _maxSupply, "max bigcat limit exceeded");
