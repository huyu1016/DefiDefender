...
contract LFTNFT is ERC721Enumerable, Ownable {
  using Strings for uint256;

  string public baseURI = "ipfs://";
  string public baseExtension = ".json";
  string public notRevealedUri = "ipfs://QmTreXvsADJkpawjBR8rnzSkXHNstaDfjT5vasYyxJTbnM/hidden.json";
  uint256 public cost = 0.05 ether;
  uint256 public maxSupply = 2019;
  uint256 public maxMintAmount = 5;
  uint256 internal _reserved = 40;
  bool public paused = true;
  bool public revealed = false;
  mapping(address => uint256) public addressMintedBalance;

  constructor() ERC721("LFT NFT", "LFT") {
  }
  ...
  function mint(uint256 _mintAmount) public payable {
    require(!paused, "The sale has not yet started");
    uint256 supply = totalSupply();
    require(_mintAmount > 0, "You need to mint at least 1 NFT");
    require(_mintAmount <= maxMintAmount, "You can only mint a maximum of 5 NFTs at a time");
