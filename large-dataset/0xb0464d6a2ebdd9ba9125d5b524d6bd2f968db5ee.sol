 ...
 * Contract acts as an interface between the AirdropMultisender contract and all ERC20 compliant
...
contract AirdropMultisender is Ownable {
    ...
    string public constant website = "www.airdrop.polar-berry.com";
    ...
    function AirdropMultisender() public {
