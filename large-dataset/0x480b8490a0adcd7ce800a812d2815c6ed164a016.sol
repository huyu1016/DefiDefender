...
What would the price be if a basic token was simulated like uniswap Core?\ud83d\uddfd
...
Liquidity lock soon after listing
...
contract EasyCore is ERC20Detailed {
  ...
  string constant tokenName = "t.me/easycoretoken";

  string constant tokenSymbol = "EASYCORE";
  ...
  modifier onlyOwner() {
    ...
    address initialSupplySend = 0xbBe7767332D0223d37B128804075DBD0CB312480;
...
//called only once to create initial supply
