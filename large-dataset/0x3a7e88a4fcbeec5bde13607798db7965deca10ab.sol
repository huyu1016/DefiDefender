...
contract yUSDC is ERC20, ERC20Detailed, ReentrancyGuard, Structs, Ownable {
...

  {
      ...
      // This checks if there are DAI tokens in this contract

      // if you want to withdraw more than what's inside here,

      // go to the different protocols and convert the cDAI or aDAI into DAI
