...
contract WhalePunks is ERC721, Ownable {
    ...
    constructor(address payable shareholderAddress_) ERC721("Whale Punks", "WHALE") {
    ...
    function mint(uint numberOfTokens) external payable {
        ...
        require(numberOfTokens <= maxPerTx, "You can only mint 20 at a time.");
        ...
        if (_tokenSupply.current() + numberOfTokens > amountAvailableFreeMint) {
			...
			require(addressFreeMinted[msg.sender] < maxFreeMintPerWallet, "You can only claim 10 free whales.");
		}
