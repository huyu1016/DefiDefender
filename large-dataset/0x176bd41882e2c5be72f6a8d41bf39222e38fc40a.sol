...
contract EtherDaddy is ERC721A, ERC721Holder, Ownable{
    ...
    uint private whitelistCount = 2;

    constructor() ERC721A("EtherDaddy", "EtherDaddy", MAX_TOKENS_PER_TX, MAX_TOKENS)  {
