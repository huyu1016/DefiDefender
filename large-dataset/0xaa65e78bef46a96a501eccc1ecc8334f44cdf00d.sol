...
contract ENRAGEDBULLS is ERC721Enumerable, Ownable {
    ...
    bytes32 private whitelistRoot = 0xe65be91ecf56e8c8ebe9fa90860753f9b58419ae72b8029371556efd370e4f08;

    //Inventory
    uint16 public maxMintAmountPerTransaction = 3;
    uint256 private  limitWallet  = 5;
    ...
    //Utility
    bool public paused = false; //change to true on for mainnet deployment
    ...
    constructor(string memory _notRevealedUrl) ERC721("META", "AMSC") {
    ...
    // public
    function mintToken(uint256 _mintAmount,bytes32[] calldata _merkleProof) public payable onlyEOA(){
        ...
        require(balanceOf(msg.sender) + _mintAmount <= limitWallet, "Exceeded max token purchase per wallet");
        require(whiteListingSale == false || _verify(leaf,_merkleProof), "You are not whitelisted!");
