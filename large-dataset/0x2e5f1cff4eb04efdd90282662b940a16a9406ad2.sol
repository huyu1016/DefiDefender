...
// File: contracts/LittleSkulls.sol
...
contract LittleSkulls is ERC721, ERC721Enumerable, Ownable {
    
    uint256 private _tokenIds;
    bool public isSaleActive = true;
    uint256 public constant MAX_TOKENS = 3333;
    uint256 public constant MAX_TOKENS_PER_PURCHASE = 33;
    string public LSKULLS_PROVENANCE = "";
    string private baseURI = "";

    uint256 private mintingFee = 3000000000000000; // 0.003 Ether
    
    
    constructor() ERC721("Little Skulls NFT", "LSKULLS") {}
    ...
    function flipSaleStatus() public onlyOwner {
        uint256 totalSupply = this.totalSupply();
        require(totalSupply < MAX_TOKENS, "Sale is over. All little skulls have been minted.");
        isSaleActive = !isSaleActive;
    }

    function setProvenanceHash(string memory _provenanceHash) public onlyOwner {
        LSKULLS_PROVENANCE = _provenanceHash;
    }
    ...
    function setBaseURI(string memory _baseURI) public onlyOwner {
        uint256 totalSupply = this.totalSupply();
        require(totalSupply == MAX_TOKENS, "Sale is still active. baseURI can only be released once all little skulls have been minted.");
        baseURI = _baseURI;
        isSaleActive = false;
    }
