...
tokenTransferBET public bebTokenTransferBET;
    ...
    function getQuanju()public view returns(uint256,uint256,uint256,uint256,uint256,uint256,uint256,uint256){

            

         return (bebjiage,bebethex,ProfitSUMBEB,SUMdeposit,SUMWithdraw,USDTdeposit,USDTWithdraw,buyOrSell);
