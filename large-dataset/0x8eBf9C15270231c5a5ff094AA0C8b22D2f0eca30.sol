/*Stealth launch - Community and social media coming soon!*/
...
contract ExtremeInu is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    uint256 public maxTransactionAmount = _tTotal * 2 / 10; // 20% maxTransactionAmountTxn
    uint256 public maxWallet = _tTotal * 2 / 10; // 20% maxWallet
    ...
    constructor() ERC20("XTRM", "Extreme Inu") {
        ...
        marketingWallet = address(0x2e2a86EbcD847139b9a25BBc4E5Bf3549f35E205); // set as marketing wallet
        devWallet = address(0x2e2a86EbcD847139b9a25BBc4E5Bf3549f35E205); // set as dev wallet
    ...
    function updateSwapTokensAtAmount(uint256 newAmount) external onlyOwner returns (bool) {
  	    ...
  	    require(newAmount <= (totalSupply() * 1 / 10) / 1e18, "Swap amount cannot be higher than 10% total supply.");
  	    swapTokensAtAmount = newAmount * (10**18);
  	    return true;
  	}
    
    function updateMaxTxnAmount(uint256 newNum) external onlyOwner {
        require(newNum <= (totalSupply() * 1 / 10) / 1e18, "Cannot set maxTransactionAmount lower than 10%");
        maxTransactionAmount = newNum * (10**18);
    }

    function updateMaxWalletAmount(uint256 newNum) external onlyOwner {
        require(newNum <= (totalSupply() * 2 / 10) / 1e18, "Cannot set maxWallet lower than 20%");
