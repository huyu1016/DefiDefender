...
contract BaseSale {
    ...
    // The ratio of Token to Ether. These rates are set when the contract gets deployed. Following figures are placeholders only.
    ...
    */
    ...
    /**
     * The owner can update the rate (Token to ETH).
     *
     * @param _rate  the new rate for converting Token to ETH
     */
...
contract Sale is BaseSale {
    ...
    /**
     * Constructor for a crowdsale of Token tokens.
     *
     ...
     * @param rateTokenToEther                 the conversion rate from Token to Ether
    ...
    constructor(
        ...
        rate = rateTokenToEther;
        withdrawRate = rateTokenToEther;
    ...
    function () public payable whenNotPaused beforeDeadline afterStartTime saleNotClosed nonReentrant {
        ...
        // and Token have the same number of decimal places (18)
     ...
     * are in units of wei and mini-Token. Every digit counts.
     *
     * @param _to            the recipient of the tokens
     * @param amountWei     the amount contributed in wei
     * @param amountMiniToken the amount of tokens transferred in mini-Token (18 decimals)
     */
    function ownerAllocateTokens(address _to, uint amountWei, uint amountMiniToken) public
            onlyOwner nonReentrant
    {
        if (!tokenReward.transferFrom(tokenReward.owner(), _to, amountMiniToken)) {
