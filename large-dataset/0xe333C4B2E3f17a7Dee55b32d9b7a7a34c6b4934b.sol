...
// File: contracts/BoredOfWorkClub.sol
...
contract BoredOfWorkClubNft is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("BoredOfWorkClub", "BWC") {
    setHiddenMetadataUri("ipfs://QmdsNw7JpfgeQoHbvTEgmWWgNh71ptsLA9yYHs6baSRos5/hidden.json");
  }
