// File: localhost/interfaces/AffiliateProgramInterface.sol
...
// File: localhost/interfaces/PepInterface.sol
...
// File: localhost/interfaces/TubInterface.sol
...
// File: localhost/interfaces/OneInchExchangeInterface.sol
...
// File: localhost/interfaces/DfFinanceMgrInterface.sol
...
contract DfFinanceMgr is FundsMgr, DSMath  {
    ...
    TokenInterface internal constant ETH_ADDRESS = TokenInterface(0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE);

    TubInterface internal constant tub = TubInterface(0x448a5065aeBB8E423F0896E6c5D525C040f59af3);
    ...
    constructor() public {
        ...
        usdToken = TokenInterface(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48); // USDC
    ...
    function migrate(bytes32[] memory cups_to_migrate) public {
        ...
        require(migrateToNewContract != DfFinanceMgrInterface(0x0));
    ...
    function changeUsdToken(TokenInterface newToken) public onlyOwner {
    ...
    function updateContract(address newContract) public onlyOwner {
        ...
        migrateToNewContract = DfFinanceMgrInterface(newContract);
    ...
    function exchange(TokenInterface fromToken, uint256 maxFromTokenAmount, TokenInterface toToken, uint256 minToTokenAmount, bytes memory _data) internal {

        OneInchExchange ex = OneInchExchange(0x11111254369792b2Ca5d084aB5eEA397cA8fa48B);
    ...
    function withdrawProfit(address payable userAddress, uint256 jam, bytes memory _usdData, uint256 minAmountAllowed) internal {
        ...
        if (minAmountAllowed == 0) {
            ...
            TokenInterface(usdToken).universalTransfer(userAddress, minAmountAllowed);
