 ...
 * @dev the interface of Uselesstoken

 */

contract UselesstokenStandard {
...
contract Uselesstoken is ERC20,UselesstokenStandard,Ownable {

    using SafeMath for uint256;



    string public name = "Uselesstoken";
    ...
    function mint() canUselesstokenMint returns (bool) {
