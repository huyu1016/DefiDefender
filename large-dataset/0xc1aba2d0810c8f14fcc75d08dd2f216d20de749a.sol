...
contract TRILL is ERC20, ERC20Detailed {
  ...
  address public owner;
    ...
    /* Price of a TRILL token, in 'wei' denomination */
  ...
  constructor () public ERC20Detailed("Trill", "TRILL", 18) {

      owner = msg.sender;

    _totalSupply = 6969 *(10**uint256(18));
