...
contract Consts {
    ...
    string public constant TOKEN_NAME = "YFZFINANCE";

    string public constant TOKEN_SYMBOL = "YFZF";

    bool public constant PAUSED = true;

    address public constant TARGET_USER = 0x9cB564Bde1DCb69b887D3FCE19dBbF0DFb20Ed82;

    

    uint public constant START_TIME = 1600574400;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[1] memory weiRaisedEndsBounds = [uint(118333333333333333333)];

        uint64[1] memory timeStartsBounds = [uint64(1600574400)];

        uint64[1] memory timeEndsBounds = [uint64(1600920000)];
        ...
        uint[2] memory weiAmountBounds = [uint(20000000000000000000),uint(3000000000000000000)];

        uint[2] memory weiAmountRates = [uint(0),uint(70)];
...

{
    ...
    constructor(MintableToken _token) public
        ...
        Crowdsale(180 * TOKEN_DECIMAL_MULTIPLIER, 0x54a427F325fD7b965667F29FfC3dd4727300322B, _token)

        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1601179200)

        CappedCrowdsale(118333333333333333333)
    ...
    function init() public onlyOwner {
        ...
        address[5] memory addresses = [address(0x0d5c7266ba6a0c1572e7614667d5e6356eba8d33),address(0x0d5c7266ba6a0c1572e7614667d5e6356eba8d33),address(0x07c9493c935c11cb877da6bfd47b84822fb3897d),address(0xd421c8a0acc384c99f7729968ecb91069553c6d5),address(0x9cb564bde1dcb69b887d3fce19dbbf0dfb20ed82)];

        uint[5] memory amounts = [uint(300000000000000000000),uint(300000000000000000000),uint(300000000000000000000),uint(300000000000000000000),uint(2500000000000000000000)];

        uint64[5] memory freezes = [uint64(1601708402),uint64(1601708402),uint64(1601708402),uint64(1601708402),uint64(0)];
