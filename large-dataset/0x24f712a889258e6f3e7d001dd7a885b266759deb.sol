...
contract CbdAllStars is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;

    uint256 public constant MAX_SUPPLY = 5000;
    uint256 public reserved = 100;
    uint256 public presaleSupply = 750;   
    ...
    constructor(string memory baseURI_) ERC721A("CBDALLSTARS", "CBDS", 20) {        
        setBaseURI(baseURI_);           
    }
    ...
    function withdraw() public onlyOwner {
        ...
        uint256 devshare = balance.mul(5).div(100); 
