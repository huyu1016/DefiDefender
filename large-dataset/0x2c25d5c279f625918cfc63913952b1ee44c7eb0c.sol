/**
 * Source Code first verified at https://etherscan.io on Tuesday, January 1, 2019
 (UTC) */
...
// File: contracts/RobotnikToken.sol

/*
 * RobotnikToken is a standard ERC20 token with some additional functionalities:
...
contract RobotnikToken is StandardToken, BurnableToken, Ownable {
	...
	uint256 public constant INITIAL_SUPPLY = 102400000000 * (10 ** uint256(decimals));
	uint256 public constant TOKEN_OFFERING_ALLOWANCE = 40960000000 * (10 ** uint256(decimals));
	...
	*/
	function RobotnikToken(address admin) public {
	...
	* @param value Amount of robotniktokens to send
	*/
