 ...
 * GUARDEX is a Unique Defi project based on rewarding holders of the GUARDEX token.

 * Our project has big development plans.

 * Over the course of a year, we have been developing a ChefGUARDEX contract to manage the GUARDEX token.
...
contract GUARDEX_Token_ERC20  is TokenERC20 {
