...
contract CappedToken is StandardToken, Ownable{
    ...
    address _distributionContract5
        ...
        balances[_distributionContract1] =  10000000 * 1 ether; /* 10 Million - seed */

        balances[_distributionContract2] =  12270000 * 1 ether; /* private sale 1 */

        balances[_distributionContract3] =  10410000 * 1 ether; /* private sale 2 */

        balances[_distributionContract4] =  63570000 * 1 ether; /* 60 Million - rest */

        balances[_distributionContract5] =  3750000 * 1 ether; /* pre public */
...
contract XEDToken is PausableToken, CappedToken {

    string public name = "Exeedme";

    string public symbol = "XED";
