...
contract Consts {
    ...
    string public constant TOKEN_NAME = "yfiLabs";

    string public constant TOKEN_SYMBOL = "YLAB";

    bool public constant PAUSED = false;

    address public constant TARGET_USER = 0xaDE39DfDBae0346FA0A55DE34a1CE6bF65234593;

    

    uint public constant START_TIME = 1600761600;
...

{
    ...
    constructor(MintableToken _token) public
        ...
        Crowdsale(5 * TOKEN_DECIMAL_MULTIPLIER, 0xaDE39DfDBae0346FA0A55DE34a1CE6bF65234593, _token)

        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1604062740)

        CappedCrowdsale(772000000000000000000)
    ...
    function init() public onlyOwner {
        ...
        address[1] memory addresses = [address(0xade39dfdbae0346fa0a55de34a1ce6bf65234593)];

        uint[1] memory amounts = [uint(5140000000000000000000)];
...

    {
        ...
        require(msg.value <= 772000000000000000000);
