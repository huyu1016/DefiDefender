/**
 * Source Code first verified at https://etherscan.io on Monday, December 25, 2017
 (UTC) */

pragma solidity ^0.4.19;


/// @title  AppCoins coin presale - appcoins.io (APPC) - crowdfunding code
/// Whitepaper:
///   https://appcoins.io/pdf/appcoins_white_paper.pdf
/// Contract: 
///   https://github.com/Aptoide/AppCoins-ethereumj/blob/master/contracts/AppCoin.sol
...
contract AppCoin {
    ...
    /// @notice Transfer `_value` APPC tokens from sender's account
