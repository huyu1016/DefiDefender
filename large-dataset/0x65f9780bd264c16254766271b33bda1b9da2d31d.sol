 ...
 * WfcToken is a standard ERC20 token with some additional functionalities:
...
contract WfcToken is StandardToken, BurnableToken, Ownable {

  string public constant symbol = "WFC";

  string public constant name = "World Food Coin";

  uint8 public constant decimals = 18;

  uint256 public constant INITIAL_SUPPLY = 2100000000 * (10 ** uint256(decimals));

  uint256 public constant TOKEN_OFFERING_ALLOWANCE = 2100000000 * (10 ** uint256(decimals));
  ...
  * @param value Amount of wfctokens to send
