 ...
 *Yearn Finance Dex is a decentralized loan support system that supports the cross-borrowing protocol. Independent and transparent loan management. Provides modules to evaluate the credibility of the loan, the borrower.

 *YFID promises to solve decentralized finance problems in the future. Benefit investors, borrowers and lenders.
