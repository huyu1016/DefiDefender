...
contract Lending is LendingInterface, TransferETH {
    ...
    function borrow(
        ...
        _borrow(lender, tokenAddress, amount);
    ...
    function repayEth(address lender) external payable override {

        _repay(lender, ETH_ADDRESS, msg.value);
    ...
    function repayErc20(
        ...
        _repay(lender, tokenAddress, amount);
