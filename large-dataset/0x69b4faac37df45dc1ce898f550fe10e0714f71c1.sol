 ...
 * TED TOKENS ARE AUTOMATICALLY RETURNED TO ETH WALLET THAT SENT THE ETH.  DO NOT USE EXCHANGES TO PURCHASE IN THIS PRESALE.
...
contract TEDpresale is Ownable {
    ...
    uint256 public minorOwnerShares = 20;
    ...
    */
    ...
    TEDToken public token;

    

    

    function TEDpresale(uint _daysToStart, address _walletMajorOwner) public 

    {

        token = TEDToken(0x2Ea3dAEF9f2F18742cC6EF67f31B6E2E03834eeC); 

        

        _daysToStart = _daysToStart * 15 days;
    ...
    function splitFunds(address _b, uint256 amount) internal {



        //owner.transfer(msg.value * referralReward / 100);
