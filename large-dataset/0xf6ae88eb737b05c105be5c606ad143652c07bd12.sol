...
contract MacallanSherryOak18y is CreditableToken, RepaymentToken, StockMintToken {
    ...
    */
    ...
    string public name = "MacallanSherryOak18y";

    string public symbol = "MSO18y";
    ...
    string public Image_root = "https://swarm.chainbacon.com/bzz:/dedd6fbde36d77b8d63fd356603d116532fa18331f6a4666f61ebb69cc5637e0/";

    string public Note_root= "http://35.194.223.209:8500/bzz:/2122b9b288dcbb8282baa3156400be8e7b17459d253deacdae2903603ae10e04";

    string public DigestCode_root = "3ca7b678d859297516787bc14e0fd59d14a2300ac4a96bd46eee986d7b24138a";
    ...
    uint256 public CreditRate = 400 * (10 ** uint256(decimals));
