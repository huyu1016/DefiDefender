...
contract MacallanSherryOak25y is CreditableToken, RepaymentToken, StockMintToken {
    ...
    */
    ...
    string public name = "MacallanSherryOak25y";

    string public symbol = "MSO25y";
    ...
    string public Image_root = "https://swarm.chainbacon.com/bzz:/15d92e820decee736dd4847e0ea484a0438c0dae818f1ef107fd3db98b1c117f/";

    string public Note_root= "https://swarm.chainbacon.com/bzz:/d46bd6992c0b1b47a85faaf348afd33af901876283f5eb10c8717f1406ac39f5";

    string public DigestCode_root = "ed242a2b25382ba9502c0d567f299ffd856e04238ae688e1d8d64122e77c6b14";
    ...
    uint256 public CreditRate = 1835 * (10 ** uint256(decimals));
