...
contract AT is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public MAX_NFT = 7000;
	uint256 public MAX_MINT_PRESALE = 7;
	uint256 public MAX_MINT_SALE = 7;
	
	uint256 public MAX_BY_MINT_IN_TRANSACTION_PRESALE = 7;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 7;
	
	uint256 public PRESALE_MINTED;
	uint256 public SALE_MINTED;
	uint256 public GIVEAWAY_MINTED;
	
	uint256 public PRESALE_PRICE = 75 * 10**15;
	uint256 public SALE_PRICE = 75 * 10**15;
    ...
    constructor() ERC721P('Athletic Tiger', 'AT') {}
