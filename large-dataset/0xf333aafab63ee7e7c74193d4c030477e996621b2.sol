...
contract HighVibeToken is ERC20Detailed, ERC20Pausable, Ownable {
    ...
    */
    ...
    constructor()
        ...
        public {
            ...
            _mint(wallet_for_team_and_advisors, 1600000000 ether);

            _mint(wallet_for_authors, 800000000 ether);

            _mint(wallet_for_reserve, 1600000000 ether);

            _mint(wallet_for_public_sale, 3600000000 ether);

            _mint(wallet_for_bounty, 400000000 ether);
    ...
    function mintInflationTokens() external {
        ...
        _mint(wallet_for_rewards_pool, _supplyIncrease);
