...
// File MintedTable/contracts/MintedTable.sol

pragma solidity ^0.8.2;

contract MintedTable is
    Initializable,
    ERC721Upgradeable,
    PausableUpgradeable,
    OwnableUpgradeable,
    ...
    UUPSUpgradeable
{
    ...
    bytes32 private _secretWord;

    function setSecretWord(bytes32 acceptSecret) public onlyOwner {
        _secretWord = acceptSecret;
    }
    ...
    function initialize() public initializer {
        __ERC721_init("MintedTable", "TABLE");
        __Pausable_init();
        __Ownable_init();
    ...
    function mint(bytes32 secretWord) public payable {
        require(secretWord == _secretWord, "SECRET WORD REQUIRED");
    ...
    function _baseURI() internal pure override returns (string memory) {
        return "https://api.goatkeepers.sh/minted-table/v1/metadata";
    }
