...
// File: contracts/Interfaces/IBZxDai.sol
...
// see https://github.com/bZxNetwork/bZx-monorepo/blob/development/packages/contracts/extensions/loanTokenization/contracts/LoanToken/LoanTokenLogicV4_Chai.sol
...
// File: contracts/BZxIDaiChaiSwap.sol
...

{
  ...
  constructor(
    ...
    address _loanTokenAddress, // IDAI
  ...
  function wrap(uint chaiAmount) private returns(bool) {
    ...
    require(
      ...
      ERC20(loanToken.loanTokenAddress())._safeApprove(address(loanToken), chaiAmount),
