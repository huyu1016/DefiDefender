...
contract PornComics is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Porn Comics", "PORN") {
    setHiddenMetadataUri("ipfs://QmaWhkCm8M6bEVxpcYH5D3DczkhCNLhNDCbFPHcJJ2PJH3/10.json");
  }
