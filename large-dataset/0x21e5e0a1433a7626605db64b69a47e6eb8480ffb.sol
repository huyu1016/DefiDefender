/**
 * Source Code first verified at https://etherscan.io on Thursday, November 30, 2017
 (UTC) */
...
contract MissCoin is ERC20,StakeStandard,Ownable {
    using SafeMath for uint256;

    string public name = "MissCoin";
