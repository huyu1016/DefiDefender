 ...
 * SuperRFI is legit fork of RFI with tweaked tokenomics to ensure pumpability ,liquidity locked for 3 months via contract

 * Made by community for community

 * SuperRFI never had presale,airdrop or dev wallet

 * Feel free to create community owned telegram group

 * Contract is 100% automated,no mint,no dev wallet and dev key burned
...
contract ERC20 is Context, IERC20 {
 ...
 function _transfer(address sender, address recipient, uint amount) internal {
        ...
        uint256 burntAmount = amount * 20 / 100;
...
contract SuperRFI is ERC20, ERC20Burnable {
