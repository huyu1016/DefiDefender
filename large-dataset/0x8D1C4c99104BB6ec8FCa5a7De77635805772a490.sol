...
contract Contract is ERC721("Metarobotica", "Metarobotica"), ERC721Enumerable, Ownable {
    ...
    */
    ...
    uint256 public constant PUBLIC_MAX_MINT = 4;
    ...
    */
    ...
    /*
     * Function setIsPublicSaleActive to activate/desactivate public sale
    */
    ...
    function setRoot(uint256 _ogRoot, uint256 _freeRoot, uint256 _wlRoot) external onlyOwner() {
    ...
    */
        ...
        payable 
    {
        ...
        require(isPublicSaleActive, 'Public is not active');
        ...
        require(_numOfTokens <= PUBLIC_MAX_MINT, 'Cannot purchase this many tokens');
        require(claimed[phase][msg.sender].add(_numOfTokens) <= PUBLIC_MAX_MINT, 'Purchase exceeds max whiteed');
