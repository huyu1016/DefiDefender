...
contract TradingBot is DyDxFlashLoan {
    ...
    function getFlashloan(address flashToken, uint256 flashAmount, address arbToken, address spender, address zrxEndpoint, bytes calldata zrxData, uint256 oneSplitMinReturn, uint256[] calldata oneSplitDistribution) external payable onlyOwner {

        uint256 balanceBefore = IERC20(flashToken).balanceOf(address(this));

        bytes memory data = abi.encode(flashToken, flashAmount, balanceBefore, arbToken, spender, zrxEndpoint, zrxData, oneSplitMinReturn, oneSplitDistribution);
    ...
    function callFunction(
        ...
        (address flashToken, uint256 flashAmount, uint256 balanceBefore, address arbToken, address _spender, address zrxEndpoint, bytes memory zrxData, uint256 oneSplitMinReturn, uint256[] memory oneSplitDistribution) = abi

            .decode(data, (address, uint256, uint256, address, address, address, bytes, uint256, uint256[]));
        ...
        _arb(flashToken, arbToken, flashAmount, _spender, zrxEndpoint, zrxData, oneSplitMinReturn, oneSplitDistribution);

    }



    function arb(address _fromToken, address _toToken, uint256 _fromAmount, address _spender, address _zrxEndpoint, bytes memory _0xData, uint256 _1SplitMinReturn, uint256[] memory _1SplitDistribution) onlyOwner payable public {

        _arb(_fromToken, _toToken, _fromAmount, _spender, _zrxEndpoint, _0xData, _1SplitMinReturn, _1SplitDistribution);

    }



    function _arb(address _fromToken, address _toToken, uint256 _fromAmount, address _spender, address _zrxEndpoint, bytes memory _0xData, uint256 _1SplitMinReturn, uint256[] memory _1SplitDistribution) internal {
        ...
        _trade(_fromToken, _toToken, _fromAmount, _spender, _zrxEndpoint, _0xData, _1SplitMinReturn, _1SplitDistribution);
    ...
    function trade(address _fromToken, address _toToken, uint256 _fromAmount, address _spender, address _zrxEndpoint, bytes memory _0xData, uint256 _1SplitMinReturn, uint256[] memory _1SplitDistribution) onlyOwner payable public {
    ...
    function _trade(address _fromToken, address _toToken, uint256 _fromAmount, address _spender, address _zrxEndpoint, bytes memory _0xData, uint256 _1SplitMinReturn, uint256[] memory _1SplitDistribution) internal {
        ...
        _zrxSwap(_fromToken, _fromAmount, _spender, _zrxEndpoint, _0xData);
    ...
    function zrxSwap(address _from, uint256 _amount, address _spender, address _zrxEndpoint, bytes memory _calldataHexString) onlyOwner public payable {

        _zrxSwap(_from, _amount, _spender, _zrxEndpoint, _calldataHexString);

    }



    function _zrxSwap(address _from, uint256 _amount, address _spender, address _zrxEndpoint, bytes memory _calldataHexString) internal {
...
//        require(sellToken.approve(_zrxEndpoint, _amount));

        require(_fromIERC20.approve(_spender, _amount));



        (bool success,) = address(_zrxEndpoint).call.value(msg.value)(_calldataHexString);
...
//        address(ZRX_EXCHANGE_ADDRESS).call.value(msg.value)(_calldataHexString);
        ...
        _fromIERC20.approve(_spender, 0);
