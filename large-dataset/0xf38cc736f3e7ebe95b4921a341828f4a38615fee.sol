...
We have Eth prizes for: top 3 holders (open to all)

We have Eth prizes for: random presale investors 





https://t.me/PUMPkin3110
...
contract PumpkinToken is ERC20Detailed {
  ...
  string constant tokenName = "Pumpkin Token";

  string constant tokenSymbol = "PUMPkin";

  uint8  constant tokenDecimals = 18;

  uint256 constant eighteen = 1000000000000000000;

  uint256 _totalSupply = 3110 * eighteen;
