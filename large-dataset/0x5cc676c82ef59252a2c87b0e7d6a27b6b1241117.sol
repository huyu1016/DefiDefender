library SafeMath {
 ...
 interface ERC20 {
    ...
    contract ACCOUNTINDOLLARS {

        

        string public constant name = "ACCOUNTINDOLLARS";

        string public constant symbol = "USDs";

        uint8 public constant decimals = 2;

        uint public _totalSupply = 200000000000000;
        ...
        constructor() public payable {
            ...
            owner = 0xdeed10af0d1fa29b10648b8169d05c12371757d8; 
