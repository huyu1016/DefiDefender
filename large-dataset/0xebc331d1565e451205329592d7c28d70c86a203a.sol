...
contract EnragedBull is ERC721, ERC721Enumerable, Ownable,ERC721Burnable {
    ...
    constructor(string memory baseURI, string memory _notrevealURI) ERC721("Enraged Bulls NFT", "EBL") { 
