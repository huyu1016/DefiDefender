...
// File: contracts/vault/PresaleVault.sol



/**

 * @title Presale Vault (Round 2)
...
contract PresaleVault is BasicVault {
    ...
    uint256 private constant MAX_ALLOCATION = 15000000 ether;

    uint256 private constant RELEASE_PERIOD = 60 days; // 120 days after the STO ends
     ...
     * @notice Create the presale vault
