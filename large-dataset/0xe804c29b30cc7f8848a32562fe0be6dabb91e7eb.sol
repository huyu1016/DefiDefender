...
contract LegozMfers is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    uint256 public constant MAXASSETS = 2000;
    uint256 public constant freeMints = 1650;
    ...
    constructor(string memory baseURI, address _proxyRegistryAddress) ERC721A("Legoz Mfers", "LegozMfer") {
        setBaseURI(baseURI);
        isSaleActive = false;
