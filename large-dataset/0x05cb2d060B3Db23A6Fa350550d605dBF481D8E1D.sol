...
contract KryptoPhrogz is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("EnvatoContract", "EC") {
  ...
  function mintWl(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(supply.current() + _mintAmount <= presale, "The presale ended!");
