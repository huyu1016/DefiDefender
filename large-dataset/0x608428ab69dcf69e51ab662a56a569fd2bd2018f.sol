...
contract HDTTokenWrapper {
    ...
    IERC20 public stakeToken = IERC20(0x80fB784B7eD66730e8b1DBd9820aFD29931aab03); 
...
contract HDTLENDPool is HDTTokenWrapper, IRewardDistributionRecipient {
    ...
    function stake(uint256 amount) public checkOpen checkStart updateReward(msg.sender){ 
        ...
        require(amount > 0, "HDT-LEND-POOL: Cannot stake 0");
    ...
    function withdraw(uint256 amount) public checkStart updateReward(msg.sender){
        ...
        require(amount > 0, "HDT-LEND-POOL: Cannot withdraw 0");
    ...
    modifier checkStart(){
        ...
        require(block.timestamp > startTime,"HDT-LEND-POOL: Not start");
    ...
    modifier checkOpen() {
        ...
        require(open, "HDT-LEND-POOL: Pool is closed");
