...
// File: contracts/vaults/golff/IGOFPool.sol
...
// File: contracts/vaults/golff/GolffVaultProvider.sol
...
contract GolffVaultProvider is VaultProvider {
    ...
    function withdraw(uint256 _amount) override onlyController external {
        ...
        IGOFPool(lend).withdraw(_amount);
    ...
    function earned() override view external returns(uint256){
        ...
        return IGOFPool(lend).earned(address(this));
