...
contract Spirit is Context, IERC20, Ownable {
    ...
    string private _name = "Spirit Protocol";
    ...
    uint256 internal _tokenTotal = 1_000e9;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'Spirit: The contract it self cannot be excluded');

        require(!_isExcluded[account], "Spirit: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        ...
        require(_isExcluded[account], "Spirit: Account is already included");
