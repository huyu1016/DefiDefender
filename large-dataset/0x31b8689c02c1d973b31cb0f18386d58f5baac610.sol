...
contract itradecoins {
    ...
    string public constant name = "Itradecoins";

    string public constant symbol = "ITRC";

    uint8 public constant decimals = 18;

    /* The initially/total supply is 10,000,000 with 18 decimals */
