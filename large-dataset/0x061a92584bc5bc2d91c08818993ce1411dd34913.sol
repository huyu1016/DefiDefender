...
contract Lock3rOracle {
    ...
    modifier upkeep() {
        ...
        uint _received = LK3R.LK3RH().getQuoteLimit(_gasUsed.sub(gasleft()));

        LK3R.receipt(address(LK3R), address(this), _received);
    ...
    ILock3r public constant LK3R = ILock3r(0xe3f3869dDD41C23Eff3630F58E5bFA584C770D67);
