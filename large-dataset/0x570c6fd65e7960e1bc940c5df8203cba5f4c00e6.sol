...
Buy DFF Dtablecoin. 1DFF=1$. Get 15% profit every day for your DFF Dollars. Dividends payments every 3 day.  
...
contract Crowdsale is ReentrancyGuard {
    ...
    function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
        ...
        if (block.timestamp >= 1601789940 && block.timestamp < 1603182600)  tokenAmount = tokenAmount.mul(185).div(100);
...
contract DFIFund is CappedCrowdsale, TimedCrowdsale, MintedCrowdsale {
