...
contract CoolCazuki is Auth, ERC721 {
  ...
  constructor(string memory newUnrevealedURI) ERC721("Cool Cazuki", "CAZ") {
  ...
  function mint(uint256 amount) external payable {
    ...
    if (msg.sender != owner) {
      ...
      if (supply <= 400) require(msg.value == 0, "Invalid ether amount");
      else require(msg.value == 0.015 ether, "Invalid ether amount");
    }
