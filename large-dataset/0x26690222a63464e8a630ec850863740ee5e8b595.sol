...
contract DegenStickyNotes is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Degen Sticky Notes", "Degen") {
    setHiddenMetadataUri("ipfs://QmWwyrDwLATjhj5Uai4tdXxdUupWWgY4ysDub4zJYYxY6m/degen_hidden_image.json");
  }
  ...
  function withdraw() public onlyOwner {
    // This will pay Degen 5% of the initial sale.
    // You can remove this if you want, or keep it in to support Degen and his channel.
    // =============================================================================
