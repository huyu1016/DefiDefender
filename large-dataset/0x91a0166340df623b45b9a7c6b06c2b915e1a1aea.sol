...
contract EvilRabbits is ERC721, Ownable {
  using Strings for uint256;
...
//   uint256 public maxMintAmountPerTx = 5;
  ...
  constructor() ERC721("EvilRabbits", "ER") {
    
    _mintLoop(msg.sender, 50);
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if(onlyWhitelisted==true){
      ...
      require(balanceOf(msg.sender)<=maxMintAmountPerPresaleAccount,"Mint limit exceeded");
    }
    else{
      require(msg.value >= cost * _mintAmount, "Insufficient funds!");
      require(balanceOf(msg.sender)<=maxMintAmountPerPublicAccount,"Mint limit exceeded");
    }
...
//   }
  function setMaxMintPresaleAccount(uint256 _maxMintAmountPerPresaleAccount) public onlyOwner {
  ...
  function addOneWhitelistUser(address _user) public onlyOwner {
