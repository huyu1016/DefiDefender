...
contract mferbestfrens is Ownable, ERC721A {
    
    uint public tokenPrice = 0.015 ether;
    uint constant maxSupply = 5555;
    uint public presale_price = 0.015 ether;
    ...
    string public baseURI = "https://www.mferbestfrens.com/api/nft/";
    uint public maxPerTransaction = 10;  //Max Limit for Sale
  
         
    constructor() ERC721A("mfer best frens", "MFRFRENS"){}
   ...
   function buy_presale(uint _count) public payable{ 
    ...
    function _baseURI() internal view virtual override returns (string memory) {
      ...
      function withdraw() external onlyOwner {
        ...
        payable(0x46C53C3AA3f3900Fb0B969dcC7B02f6278Fc7274).transfer(_balance * 50/100); 
        payable(0x1C03FBd488d2E65555BdF27E142DB8d94b01B04b).transfer(_balance * 50/100); 
    }
