 ...
 * @title VKCTokenStandard

 * @dev the interface of VKCTokenStandard

 */

contract VKCTokenStandard {
...
contract VKCToken is ERC20,VKCTokenStandard,Ownable {
    ...
    function mint() canVKCMint returns (bool) {
