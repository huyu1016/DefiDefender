...
contract MSZGovernor is Governor, GovernorSettings, GovernorCountingSimple, GovernorTimelockControl {
    ERC721Checkpointable public immutable genesis;
    ERC721Checkpointable public immutable origins;
    ERC721Checkpointable public immutable elementals;
    uint256 private _quorum;

    constructor(
        ERC721Checkpointable _genesis,
        ERC721Checkpointable _origins,
        ERC721Checkpointable _elementals,
        TimelockController _timelock
    )
        Governor("MetaStonez Governor")
        GovernorSettings(19636 /* 3 day */, 32727 /* 5 day */, 1e18)
    ...
    function getVotes(address account, uint256 blockNumber)
        ...
        returns (uint256)
    {
        return genesis.getPriorVotes(account, blockNumber)
            + origins.getPriorVotes(account, blockNumber)
            + elementals.getPriorVotes(account, blockNumber);
    }
