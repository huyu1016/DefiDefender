...
// File: contracts/HalfSendChickens.sol
...
contract HalfSendCocaineChickens is Ownable, ERC721A, ReentrancyGuard {
  ...
  ) ERC721A("Half Send - Cocaine Chickens", "HalfSend", maxBatchSize_, collectionSize_) {
    require(amountForAuctionAndDev_ <= collectionSize_, "larger collection size needed" );
  }
    
    uint256 pricePer = 0.03 ether;
    uint256 totalCost;
  ...
  function mint(uint256 quantity) external payable {
    ...
    require(totalSupply() + quantity <= 4445);
