...
contract BuyNFTByStableCoin is Ownable {
    ...
    ERC20BasicInterface public erc20 = ERC20BasicInterface(0x89d24A6b4CcB1B6fAA2625fE562bDD9a23260359); // DAI



    // ERC20BasicInterface public erc20 = ERC20BasicInterface(0xCfB13a54919250f6d3458E304a9ABFDc77cc87f2); // rinkeby

    // ERC20BasicInterface public hbwalletToken = ERC20BasicInterface(0x91013928b1C4dbd0D5cB21BA5b052BfD840A7a7F); // rinkeby

    // ERC20BasicInterface public erc20 = ERC20BasicInterface(0xC4375B7De8af5a38a93548eb8453a498222C4fF2); // kovan

    // ERC20BasicInterface public hbwalletToken = ERC20BasicInterface(0x614F3262c6df42b174cF8544454D6Dc39A9768D2); //kovan
