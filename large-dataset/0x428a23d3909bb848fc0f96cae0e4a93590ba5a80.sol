...
contract ZenDAOya is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmRMkKKUnp8vvgyWz9CHhA3EvufoH2jjVWuq16LY8MiSt4";

    uint256 public constant MAX_MINTS_PER_TX = 5;
    uint256 public maxSupply = 1106;
    ...
    constructor(
    ) ERC721A("ZenDAOya", "ZenDAOya", 100, maxSupply) {
    }
