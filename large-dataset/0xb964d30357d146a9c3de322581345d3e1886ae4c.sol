...
contract EURTToken is StandardToken, BurnableToken, ERC20Mintable {



    using SafeMath for uint;

    string constant public symbol = "EURT";

    string constant public name = "European Currency Unit Tether";
