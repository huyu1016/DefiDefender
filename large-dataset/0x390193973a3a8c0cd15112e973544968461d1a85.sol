...
contract YoungKingsClub is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;
  Counters.Counter private supply;
  string public uriPrefix = "ipfs://QmdMDsJYa61znwnLn2kLxLytt6V9X8xbaDvns8d4rfubs9/";
  string public uriSuffix = ".json";
  string public hiddenMetadataUri;
  uint256 public preSaleWalletLimit = 3;
  uint256 public publicSaleWalletLimit = 10;
  ...
  constructor() ERC721("Young Kings Club", "YKC") {
    setHiddenMetadataUri("ipfs://QmNRyenZ1hADBhVZwCME83df38yVqpzd3ziPeqoqDqPsUn/hidden.json");
  }
  ...
  function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    require(!preSale, "Public sale is not yet open");
  ...
  function preSaleMint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    if(preSale = true)        
        require(
            balanceOf(msg.sender) + _mintAmount <= preSaleWalletLimit,
            "Max NFT mint limit reached. Try minting in next sale"
            );
