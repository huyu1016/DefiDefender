 ...
 * This is a degen token, so please do your own research before jumping in.

 * Understand risk vs reward. Weighh them both and if reward is better, come join.

 * 

 * TG: https://t.me/antisfi
...
contract AntiSFI is Context, Ownable, ERC20Detailed, GasPump 

{
  ...
  string constant tokenName = "AntiSFI";

  string constant tokenSymbol = "AntiSFI";

  uint8  constant tokenDecimals = 18;

    uint256 private _totalSupply = 400 * (10 ** 18);
