...
contract FMfers is ERC721Enumerable, Ownable
{
    ...
    uint public maxPerTxn = 10; // 10
    uint public maxPerWallet = 10; // 10 - initial 1k , none - public
    
    uint256 public price = 0 ether; 
    uint public status = 0; //0 - pause , 1- public
    
    bool public revealed = false;
    string public unrevealedUri = "https://gateway.pinata.cloud/ipfs/QmaL3MmRdotFRRxoixuPx7hq8E39iD6Ppt5WFWDGbw9JFF"; 



    constructor() ERC721("Fuzzy Mfers", "FMfers")  {
        setBaseURI(""); 
    }
    ...
    function setRevealed(string memory baseURI) public onlyOwner() {
        revealed = !revealed;
        setBaseURI(baseURI);
    } 
    ...
    function mint(uint chosenAmount) public payable isSaleOpen{
        ...
        require( totalSupply() > 1000 || ( chosenAmount + balanceOf( msg.sender ) <= maxPerWallet ) , "Chosen Amount exceeds MaxQuantity" );
    ...
    function withdraw() public onlyOwner {
        ...
        //5% 0x86fc9DbcE9e909c7AB4D5D94F07e70742E2d144A
        //95% to owner
    ...
    function contractURI() public view returns (string memory) {
        return "https://gateway.pinata.cloud/ipfs/QmUeUgkeFkyLFoEcXgWR8taQ6obkjCnFAqgqrWa77tWCtL";
    }
}
