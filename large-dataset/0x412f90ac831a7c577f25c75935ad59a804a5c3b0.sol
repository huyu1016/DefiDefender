...
// Offical telegram ---- https://t.me/rbas3_finance ----

// Forked the original audited code from RBASE, no material chnages have been made apart from strating with a 0% that will be increased to 3% after presale concludes
...
contract RBAS3 is ERC20UpgradeSafe, OwnableUpgradeSafe {
  ...
  uint256 private _totalSupply;
...

    {
        ...
        __ERC20_init("rbas3.finance", "RBAS3");
        ...
        _tFeePercent = 0; //starting with 0.00% fee
