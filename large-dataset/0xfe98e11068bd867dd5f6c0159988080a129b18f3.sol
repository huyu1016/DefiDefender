...
contract Configurable {
    ...
    uint256 public cap = 300000*10**18;           //---------| 300k Tokens for Presale |---------

    uint256 public basePrice = 5000*10**18;      //-----| 1 ETH = 5000 Tokens |---------

    uint256 public tokensSold = 0;

    uint256 public tokenReserve = 500000*10**18; //-----------| 500k Tokens Total Supply |------
...
//        require(isWhitelisted(_msgSender()) == true, "This address is not whitelisted");
        ...
        require(msg.value <= 2e18 && msg.value >= 3e17, "You can send at least 0.3 ETH but not more than 2 ETH");
        ...
        require(ethBalances[_msgSender()] <= 2e18, "Cannot send more than 2 ETH");

        require(ethBalances[address(this)] <= 60e18, "Target amount of 60 ETH reached");
...
contract GR1NCH is CrowdsaleToken {

    string public name = "GR1NCHFY";

    string public symbol = "GR1NCH";
