...
contract Mories is ERC721A, Ownable, ReentrancyGuard {
    using Strings for uint256;
    ...
    modifier mintCompliance(uint256 _mintAmount) {
        ...
        require((_currentIndex - 1) + _mintAmount <= MAX_SUPPLY, "Max supply exceeded!");
    ...
    function mint(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
        ...
        if ((_currentIndex - 1) < FREE_SUPPLY) {
