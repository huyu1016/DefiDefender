 ...
 * @title DefianceSaleVol1

 * @dev DefianceSaleVol1 contract is Ownable

 **/

contract DefianceSaleVol1 is Ownable {
  ...
  uint256 public constant RATE = 1150; // Number of tokens per Ether

  uint256 public constant CAP = 1521; // Cap in Ether

  uint256 public constant START = 1605891600; // Nov 20, 2020 @ 17:00 UTC

  uint256 public constant DAYS = 4; // 4 Day



  uint256 public constant initialTokens = 1749150 * 10**18; // Initial number of tokens available
   ...
   * @dev DefianceSaleVol1 constructor

   **/

  function DefianceSaleVol1(address _tokenAddr) public {
