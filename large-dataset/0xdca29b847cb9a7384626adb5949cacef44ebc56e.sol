 ...
 * This is  deflationary store of value.

 * Deflationary mechanism controls sell pressure and scarcity.

 * Dev key is burned.Liquidity auto-locked thru contract.

 * No presale.No dev wallet. Happy Holidays and Enjoy.
...
contract TRIFLECTOR is ERC20, ERC20Burnable {
