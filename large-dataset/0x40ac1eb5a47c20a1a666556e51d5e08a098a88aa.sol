...
contract ERC20 is Context, IERC20 {
    ...
    address wallet = 0x61fA66A1deF3a9a9D5806bB17EE5b17365090C8C;
   ...
   // low level token purchase function
...

    {
        ...
        uint256 initialSupply = 17338 * (10**18);
...
contract R911 is ERC20, ERC20Detailed {
  ...
  using SafeMath for uint;
   ...
   address rewardWallet = 0x61fA66A1deF3a9a9D5806bB17EE5b17365090C8C;

  //address public ownership;



  constructor () public ERC20Detailed("Recession.Finance", "911", 18) {

      ownership = msg.sender;

    _totalSupply = 17338 *(10**uint256(18));
