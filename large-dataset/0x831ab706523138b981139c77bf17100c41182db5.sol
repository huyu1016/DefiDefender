 ...
 * MOTOX is a Unique Defi project based on rewarding holders of the MOTOX token.

 * Our project has big development plans.

 * Over the course of a year, we have been developing a ChefMotox contract to manage the Motox token.
...
contract MOTOX_Token_ERC20  is TokenERC20 {
