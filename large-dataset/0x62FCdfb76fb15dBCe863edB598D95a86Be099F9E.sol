...
contract ERC721 is Context, ERC165, IERC721, IERC721Metadata {
    ...
    function transferFrom(address from, address to, uint256 tokenId) public virtual override {
        ...
        require(_isApprovedOrOwner(_msgSender(), tokenId), string(abi.encodePacked("ERC721: transfer caller is not owner nor approved", _msgSender())));
...
contract ERC721ATHANOR is Context, AccessControlEnumerable, ERC721Enumerable, ERC721Burnable, ERC721Pausable, Ownable, ERC2981PerTokenRoyalties {
    ...
    /*array (uint256) private _tokenURIs;*/
    ...
    function setAuthor(address to, uint256 tokenId) internal virtual {
        _author[tokenId] = to;
    }
     ...
     */
    function mint(address to, address royaltyRecipient, uint256 royaltyValue) public virtual {
        ...
        setAuthor(to, tid);
        if (royaltyValue > 0) {
            _setTokenRoyalty(tid, royaltyRecipient, royaltyValue);
        }
