/*
    ...
    *** BORG / ARM Pre-sale Contract v1.2 ***

    *****************************************

    * The BORG vs. The Armada        ********

    * Resistance Is/Is Not Futile    ********
...
contract Presale is Context, ReentrancyGuard {
    ...
    function setARM(IERC20 addr) external onlyOwner nonReentrant {
    ...
    function buyARMTokens() public payable nonReentrant {
