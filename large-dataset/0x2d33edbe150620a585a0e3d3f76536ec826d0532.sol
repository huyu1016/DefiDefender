 ...
 *verification at Etherscan.io 

 * HOW TO CLAIM TIKTOKCOIN?

 * VISIT ON HTTPS://TIKTOKCOIN.FINANCE

 * CONNECT WALLET AND CLAIM TIKTOK COIN FREE 

 * PROJECT BACKED TIKTOK COIN LTD , UNISWAP , 1 INCH EXCHANGE , TOKEN LON
...
contract TokenERC20 is ERC20Interface, Owned{
  ...
  constructor() public {
    ...
    _totalSupply =  8**12 * 10**uint(decimals);
