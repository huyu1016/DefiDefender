...
contract SuperApesClub is ERC721, Ownable, ReentrancyGuard {
    ...
    string private unrevealedTokenURI = "ipfs://QmNPPL5RzuDa7VCFAxCypASBUdnoURWprr9G46sBCJzpZu/placeholder.json";
    ...
    address a1 = 0x2FCA6D62419eaa87905C54f12Aa5abD93aF3A1C6;
    address a2 = 0xa9a7bDCE05Eb3cbff2537D2721406Be53171EE61;

    event TokenMinted(uint256 tokenId);

    constructor(string memory _ipfsCID)
        ERC721("Super Apes Club", "SAC")
    {
        baseURI = string(abi.encodePacked("ipfs://", _ipfsCID, "/"));

        /*
         * Full reveal of the Super Apes Club would be 13 days from the day of deployment of the contract.
         */
        REVEAL_TIMESTAMP = block.timestamp + 86400 * 13;
    }
     ...
     * Mints Super Apes
     */
    function mintSuperApes(uint256 _amount) public payable {
