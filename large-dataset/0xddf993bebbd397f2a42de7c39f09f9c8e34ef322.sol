 ...
 * @title ERC20 token contract of Cronos Coin
...
contract ERC20Token is ERC20, ERC20Detailed, Ownable, ERC20Burnable {
  ...
  uint256 public constant INITIAL_SUPPLY = 315360000 * (10 ** uint256(DECIMALS));
  ...
  constructor () public ERC20Detailed("Cronos Coin", "CRO", DECIMALS) {
