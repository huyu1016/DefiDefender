...
contract NAVFeed is BaseNFTFeed, Interest, Buckets, FixedPoint {
    ...
    uint constant public  WRITE_OFF_PHASE_F = 1005;
    ...
    function init() public {
        ...
        // risk group: 0
        file("riskGroup", 0, ONE, ONE, uint(1000000002473363774733637747), 99.90 * 10**25);
        ...
        // write-off group: 1 - 40% write off
        setWriteOff(1, WRITE_OFF_PHASE_B, ONE, 60 * 10**25);
        // write-off group: 2 - 90% write off
        setWriteOff(2, WRITE_OFF_PHASE_C, ONE, 10 * 10**25);
        // write-off group: 3 - 10% write off
        setWriteOff(3, WRITE_OFF_PHASE_D, ONE, 90 * 10**25);
        // write-off group: 4 - 40% write off
        setWriteOff(4, WRITE_OFF_PHASE_E, ONE, 60 * 10**25);
        // write-off group: 5 - 90% write off
        setWriteOff(5, WRITE_OFF_PHASE_F, ONE, 10 * 10**25);
    }
