...
contract MintableToken is StandardToken, Ownable {
    string public constant name = "PleasureToken";
...
contract Crowdsale is Ownable {
    ...
    uint256 public hardWeiCap = 49700 * (10 ** 18);
...
contract PLTCrowdsale is Ownable, Crowdsale, MintableToken {
    using SafeMath for uint256;
...
*/
    ...
    uint256 public fundForSale = 350 * (10 ** 6) * (10 ** uint256(decimals));
    uint256 public weiMinSale = 2 * 10 ** 16;
    ...
    /**
    * Pre Sale              1 ETH = 30,000 token -- Limit = 50,000,000  tokens
    * 1 Stage               1 ETH = 15,000 token -- Limit = 25,000,000  tokens
    * 2 Stage               1 ETH = 7,250  token -- Limit = 25,000,000  tokens
    * 3 Stage               1 ETH = 7,000  token -- Limit = 25,000,000  tokens
    * 4 Stage               1 ETH = 6,750  token -- Limit = 25,000,000  tokens
    * 5 Stage               1 ETH = 6,500  token -- Limit = 25,000,000  tokens
    * 6 Stage               1 ETH = 6,250  token -- Limit = 25,000,000  tokens
    * 7 Stage               1 ETH = 6,000  token -- Limit = 25,000,000  tokens
    * 8 Stage               1 ETH = 5,750  token -- Limit = 25,000,000  tokens
    * 9 Stage               1 ETH = 5,500  token -- Limit = 25,000,000  tokens
    * 10 Stage              1 ETH = 5,250  token -- Limit = 25,000,000  tokens
    * 11 Stage              1 ETH = 5,000  token -- Limit = 50,000,000  tokens
    *
    */
    ...
    function getPeriod(uint256 currentTokenAllocated) public view returns (uint) {
        if(currentTokenAllocated > limits[11]){
            return 12;
        }
        for(uint i = 11; i > 0; i--){
