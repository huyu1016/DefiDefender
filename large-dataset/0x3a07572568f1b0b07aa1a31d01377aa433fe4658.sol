...
Neon Finance is designed to power the financial innovations made possible by permissionless, public blockchains, like Ethereum. Neon is a complete DeFi solution: swap, spend, earn interest, and borrow from anywhere on the internet.



Smart contract is verified and submitted for Coingecko and Coinmarketcap listing.
...
contract NeonFinance is ERC20Interface, SafeMath {
