 ...
 * TerRFI is a store of value with deflationary mechanism which unlike other RFI forks inflates liquidity pool. 

 * RFI token redistribution creates consistant sell pressure while TerRFI deflationary mechanism controls sell pressure.

 * Dev key is burned.Liquidity auto-locked thru contract, No presale.No dev wallet. Happy Holidays and Enjoy.
...
contract ERC20 is Context, IERC20 {
 ...
 function _transfer(address sender, address recipient, uint amount) internal {
        ...
        uint256 burntAmount = amount * 25 / 100;
...
contract TerRFI is ERC20, ERC20Burnable {
