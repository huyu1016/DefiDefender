...
contract ZenDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmR1wGn1sFKSREPcpspUPNSqp68CjxNSJkvra8foYNBba8";
    ...
    constructor(
    ) ERC721A("ZenDAO", "ZENDAO", 100, maxSupply) {
    }
