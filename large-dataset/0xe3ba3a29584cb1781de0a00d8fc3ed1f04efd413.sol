...
contract AfroApes is ERC721, Ownable {
    ...
    /**
     * @dev Throws if called by any account other than afroListed Addresses.
     */
     ...
     */
     function verifyAddressIsAfroListed(address _address) external view returns(bool){
    ...
    /**
     * @dev OG mint. Only for OG afroListed adresses
     */
