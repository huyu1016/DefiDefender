...
contract Getter is Upgradable {
    ...
    function getEgg(uint256 _id) external view returns (
      ...
      uint16 gen, uint32 coolness, uint256[2] parents, uint8[11] momDragonTypes, uint8[11] dadDragonTypes
    ...
    function getDragonProfile(uint256 _id) external view returns (
        ...
        bytes32 name, uint16 generation, uint256 birth, uint8 level, uint8 experience, uint16 dnaPoints, bool isBreedingAllowed, uint32 coolness
    ...
    function getDragonCurrentHealthAndMana(uint256 _id) external view returns (
      ...
      uint32 health, uint32 mana, uint8 healthPercentage, uint8 manaPercentage
    ...
    function getDragonHealthAndMana(uint256 _id) external view returns (
        ...
        uint256 timestamp, uint32 remainingHealth, uint32 remainingMana, uint32 maxHealth, uint32 maxMana
    ...
    function getDragonSpecialAttack(uint256 _id) external view returns (
      ...
      uint8 dragonType, uint32 cost, uint8 factor, uint8 chance
