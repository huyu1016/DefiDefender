...
contract SWTToken is IERC20 {
    ...
    uint public _icoSupply = 7000e18; // crowdsale
    ...
    uint public PRICE = 40;

    uint public maxCap = 7000e18 ether; // 50000 ether
    ...
    // Constructor
    // @notice SWTToken Contract
    // @return the transaction address
    function SWTToken() public payable {
        startTime = now;
        owner = msg.sender;
