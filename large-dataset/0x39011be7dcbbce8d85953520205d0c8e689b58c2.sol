/**
 * Source Code first verified at https://etherscan.io on Saturday, September 8, 2018
 (UTC) */

pragma solidity ^0.4.18;

// ----------------------------------------------------------------------------
// 'LCARS' token contract
//
...
contract LCARS is ERC20Interface {
    uint256 public constant decimals = 18;

    string public constant symbol = "LCARS";
    string public constant name = "LCARS";

    bool public _selling = true;//initial selling
    uint256 public _totalSupply = 10 ** 14; // total supply is 10^14 unit, equivalent to 10^9 LCARS
    uint256 public _originalBuyPrice = 43 * 10**7; // original buy 1ETH = 4300 LCARS = 43 * 10**7 unit

    // Owner of this contract
    address public owner;
 
    // Balances LCARS for each account
    ...
    function setBuyPrice(uint256 newBuyPrice) 
        ...
        _originalBuyPrice = newBuyPrice; // 3000 LCARS = 3000 00000 unit
        // control _maximumBuy_USD = 10,000 USD, LCARS price is 1.0USD
        // maximumBuy_LCARS = 100,000 LCARS = 100,000,00000 unit
        // 3000 LCARS = 1ETH => maximumETH = 100,000,00000 / _originalBuyPrice
