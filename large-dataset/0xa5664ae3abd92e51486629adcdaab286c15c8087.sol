...
contract COREcreditv2 is ERC20Detailed {
  ...
  string constant tokenName = "COREcredit.info";

  string constant tokenSymbol = "CORECFv2";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0x02114DEdB7E1FA2D3B52B2dd043782230c68e948, tokensToBurn);
