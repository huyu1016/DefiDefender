...
// File: contracts/madisondaov2.sol
...
contract MadisonDAOV2 is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmZb5M2sm8GjxfqtGJzNsQrUx4z6jQVW8jyxSmUYuns6MT";
    ...
    constructor(
    ) ERC721A("MadisonDAO V2", "MDAO", 100, maxSupply) {
    }
