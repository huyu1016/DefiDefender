...
contract FHAPEPRIME is ERC721A, Ownable {
    uint256 public NFT_PRICE = 0.019 ether;
    uint256 public MAX_SUPPLY = 8191;
    uint256 public MAX_MINTS = 10;
    uint256 public MAX_MINTS_RESERVED = 10;
    uint256 public freeTokens = 3000;
    string public projName = "FHAPE PRIME";
    string public projSym = "FHAPE";

    bool public DROP_ACTIVE = false;

    string public baseURI = "https://ipfs.io/ipfs/QmSph3k6T2qqoKuKNWyVR5Rhrwx6FY7yPhnhEtTvZvTZg5/";
