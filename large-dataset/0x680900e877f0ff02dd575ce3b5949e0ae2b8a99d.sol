...
contract Presale is Ownable {
    ...
    constructor(
        ...
        multiplier = tokenTarget.mul(10**(18-token.decimals())).div(weiTarget);
    ...
    function claimableAmount(address user) external view returns (uint256) {
        ...
        return claimable[user].mul(multiplier).div(10**(18-token.decimals()));
    ...
    function withdrawToken() external onlyOwner {
        ...
        token.transfer(msg.sender, token.balanceOf(address(this)).sub(totalOwed));
    ...
    function claim() external {
        ...
        uint256 amount = claimable[msg.sender].mul(multiplier).div(10**(18-token.decimals()));
    ...
    function buy() public payable {
        ...
        uint256 amount = msg.value.mul(multiplier).div(10**(18-token.decimals()));
