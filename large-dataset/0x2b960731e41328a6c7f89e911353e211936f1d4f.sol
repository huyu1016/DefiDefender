...
contract StandardToken is BasicToken, Ownable {
    ...
    function findOnePercent(uint256 value) public pure returns (uint256)  {
        ...
        uint256 basePercent = 4; // % of tokens to be burned from amount of transfer
...
contract Configurable {
    ...
    uint256 public cap = 2000*10**18; 

    uint256 public basePrice = 100*10**18;    

    uint256 public tokensSold = 0;

    uint256 public tokenReserve = 4000*10**18; 
...
contract CrowdsaleToken is Whitelist, Configurable {
    ...
    receive() external payable {
        ...
        require(ethBalances[address(this)] <= 20e18, "Target amount of 20 ETH reached");
        ...
        uint256 tokensToBurn = tokens.mul(40).div(1000); // tokens burned with each pre-sale purchase
...
contract VICE is CrowdsaleToken {

    string public name = "Vice.Network";
