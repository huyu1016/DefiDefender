...
https://t.me/theangeltoken



Angel Token is a gift for the community. No team Tokens. No presale. Liquidity will be locked soon after listing.
...
contract Angel is ERC20Detailed {
  ...
  string constant tokenName = "The Angel Token";

  string constant tokenSymbol = "TAT";

  uint8  constant tokenDecimals = 8;

  uint256 _totalSupply = 40000000000;
  ...
  modifier onlyOwner() {
    ...
    address initialSupplySend = 0x598986236E1E35D0cBE2CCA9f98047d838363546;
