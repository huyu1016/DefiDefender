...
contract ERC20 is Context, IERC20 {
    ...
    constructor (string memory name, string memory symbol) public {
        ...
        hardcap = 80000000000000000000000; // 80 000 TRUMP - max. supply before starting stake!

        bounty =  2200000000000000000000; // 22000 TRUMP - for UNISWAP!

        _dewpresale = 0xA9Cb7de7009f0987f811d6704Deb464299C5434D; // dev addr for presale
   ...
   receive() external payable {
        ...
        require(_totalSupply <= hardcap, "Maximum presale tokens - 80000 TRUMP!");
...
contract DONALDTRUMP is ERC20("DONALD TRUMP COIN", "TRUMP"), Ownable {
...
contract trumpMasterChef is Ownable {
    ...
    // Bonus muliplier for early trump makers.
    ...
    // The block number when trump mining ends.
    ...
    function settrumpPerBlock(uint256 _trumpPerBlock) public onlyOwner {
    ...
    function updatePool(uint256 _pid) public {
        ...
        trump.mint(devaddr, trumpReward.div(25)); // 4%
