...
// File: BoredApeYachtClub.sol

pragma solidity ^0.8.0;


contract BoredApeYachtClub is Ownable, ERC721A, ReentrancyGuard {
    uint256 public constant PRICE = 0.01 ether;
    uint256 public constant MAX_APES_PURCHASE = 10;
    uint256 public constant MAX_APES = 10000;
    uint256 public constant MAX_BATCH_SIZE = 10;
    address private constant THE_TEAM = 0xf7E414BB95d4262C0aB82D84e4f0bE8fBb16efa1;
    ...
    constructor() ERC721A("BoredApeYachtClub", "BAYC", MAX_BATCH_SIZE, MAX_APES) {
    }
    ...
    modifier mintGuard(uint256 tokenCount) {
        ...
        require(totalSupply() + tokenCount <= MAX_APES, "Not enough supply");
        require(tokenCount <= MAX_APES_PURCHASE, "Exceeds token txn limit ");
        _;
    }

    function reservePENGS(uint256 amount) external onlyOwner {
        require(totalSupply() + amount <= MAX_APES, "Not enough supply");
    ...
    function mintPresale(bytes32[] calldata proof, uint256 amount) external payable mintGuard(amount) {
        ...
        require(presaleAddressMintCount[msg.sender] + amount <= MAX_APES_PURCHASE, "Address already minted allocation");
    ...
    function withdraw() external onlyOwner {
        payable(THE_TEAM).transfer(address(this).balance);
    }
}
