...
contract KylerAndJesus is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Strings for uint256;

    string public constant baseURI = "ipfs://QmV8Qwek7X7G3ShndVbghQTok9gn7DoGmk8r1BiYpnx8Qt/";
    string public constant contractURI = "ipfs://QmaoB37SbNai2adSwpgsvM45uj4Hsrx8bRTR33nHTQaKhZ";
    string public constant baseExtension = ".json";
    address private openSeaProxyRegistryAddress = 0xa5409ec958C83C3f309868babACA7c86DCB077c1;
    // Mainnet - 0xa5409ec958C83C3f309868babACA7c86DCB077c1
    // Rinkeby - 0xF57B2c51dED3A29e6891aba85459d600256Cf317

    uint256 public constant MAX_FREE_MINTS_PER_TX = 10;
    ...
    uint256 public NUM_FREE_MINTS = 760;
    ...
    modifier freeMintsAvailable(uint256 numberOfTokens) {
        require(
            totalSupply() + numberOfTokens <= NUM_FREE_MINTS,
    ...
    constructor() ERC721A("KylerAndJesus", "K&J", 100) { }
