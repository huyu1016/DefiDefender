...
contract YFST is ERC20, Ownable {
    ...
    uint256 private _privateRate=14; //1 eth = 14 tokens = 71428571428571400 wei

    uint256 private _presaleRate=11; //1 eth = 11 tokens = 89285714285714300 wei
    ...
    uint256 _privateOpen=1601467200;

    uint256 _presaleOpen=1601553600;
    ...
    modifier PrePeriod{
        ...
        require(block.timestamp<_presaleOpen, "Presale Finished");
    ...
    function rate() public view returns (uint256) {
        ...
        if( block.timestamp<= _privateOpen){
