...
contract MithrilLottery is WhitelistAdminRole {
    ...
    uint public ticketPrice = 100 ether;

    uint firstStageWinningPrice = 0;
    ...
    */
    ...
    function setBets(uint[] memory numbers) public {
        ...
        currentRewardVolumn += ticketPrice * 65 / 100;
    ...
    function countRewardFirstBatch() public onlyWhitelistAdmin {
        ...
        if (countSize < COUNT_WINNING_STAGE_BATCH_SIZE || countRewardFirstUserOffset == users.length) {
            ...
            uint secondStageTotalPrice = (remainingPrice * 7 / 100) + remainingSecondtVolumnBefore;

            uint thirdStageTotalPrice = (remainingPrice * 65 / 1000) + remainingThirdVolumnBefore;
