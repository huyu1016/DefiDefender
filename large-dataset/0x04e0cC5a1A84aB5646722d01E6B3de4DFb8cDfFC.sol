...
abstract contract ERC721Enumerable is ERC721, IERC721Enumerable {
    ...
    contract GorillaFrens is ERC721, Ownable, ERC721Enumerable {
      using SafeMath for uint256;
      using Strings for uint256;
    
      uint256 public constant tokenPrice = 50000000000000000; // 0.05 ETH 
      uint256 public constant maxTokenPurchase = 7;
      uint256 public constant MAX_TOKENS = 7777;
      uint256 public presaleMaxMint = 7; //MAX MINT OF PRESALE
      uint256 public devReserve = 77; //RESERVE MINT FOR DEVELOPERS
    
      string public baseURI = ""; // IPFS URI WILL BE SET ON REVEAL
      ...
      event GorillaFrensMinted(uint256 tokenId, address owner);
    
      constructor() ERC721("Gorilla Frens", "GRFS") {} //SET SYMBOL UND NAME
      ...
      function mintGorillaFrens(uint256 numberOfTokens) external payable {
        ...
        for (uint256 i = 0; i < numberOfTokens; i++) {
          ...
          if (totalSupply() < MAX_TOKENS) {
            ...
            emit GorillaFrensMinted(id, msg.sender);
          }
        }
      }
    
      function presaleGorillaFrens(uint256 numberOfTokens) external payable {
        ...
        returns (string memory)
      {
        ...
        if (isRevealed == false) {
          return
            "ipfs://QmPByanffrowiqqjvDF5tALKxoKdbmewNoME7CCaSqx4mi/unRevealed.json"; // SET UNREVEALED METADATA
        }
