...
contract PhantaFrens is ERC721Enumerable, Ownable, ReentrancyGuard {
  ...
  uint256 public constant MAX_TOKENS = 5511;
  uint256 public constant FREE_TOKENS = 501;
  uint256 public constant MAX_FREE_PER_WALLET = 6;
  ...
  constructor() ERC721("Phanta Frens", "PFRENS") {
  ...
  function withdraw() public onlyOwner nonReentrant {
    ...
    address payoutAddress1 = payable(0x9300138bB989141664a320F4f16A7320dEE1b998);
    uint256 payoutPayment1 = balance.mul(15).div(100);

    address payoutAddress2 = payable(0x47B46e1469E49499602a50a60c64E5f6a4600bBa);
    uint256 payoutPayment2 = balance.mul(25).div(100);

    address payoutAddress3 = payable(0xF3417D4af5449Fc6D13f3611B4D4D385A104072E);
    uint256 payoutPayment3 = balance.mul(25).div(100);

    address payoutAddress4 = payable(0xDfeec56E9a2De4d3E92E54F4b70E5DE0C4D4E97D);
    uint256 payoutPayment4 = balance.mul(25).div(100);
