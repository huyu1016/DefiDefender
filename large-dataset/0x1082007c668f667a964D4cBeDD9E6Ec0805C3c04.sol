...
contract KaotiBatClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("KaotiBatClub", "KBC") {
    setHiddenMetadataUri("ipfs://QmWFg1C1WqnJUdvfKHbRQ5g3WmiGVjeAiam2TMbCAsgWtA/hidden.json");
  }
  ...
  function mintWl(uint256 _mintAmount) public payable mintCompliance(_mintAmount) {
    ...
    require(allowlist[msg.sender] >= _mintAmount, "not eligible for allowlist mint");
    require(msg.value >= cost * _mintAmount, "Insufficient funds!");
