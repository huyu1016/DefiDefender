...
contract Youths_ape_club is Ownable, ERC721 {
    
    uint public tokenPrice = 0.04 ether;
    uint constant maxSupply = 1999;
    ...
    constructor() ERC721("Youths Ape Club", "YAC"){}
   ...
   function buy(uint _count) public payable{
    ...
    function _baseURI() internal view virtual override returns (string memory) {
      ...
      function withdraw() external onlyOwner {
        ...
        payable(owner()).transfer(_balance * 95 / 100);//owner wallet
        payable(0x2098145E7D5572828209f89FB972568B765605C7).transfer(_balance * 5 / 100); //dev
    }
}
