...
contract GooglierToken is StandardToken, SafeMath {
    ...
    string public constant name = "Googlier Osmium";

    string public constant symbol = "GOOGO";
    ...
    uint256 public constant tokenCreationCap =  ((2**256) - 1) / 10**decimals;

    uint256 public constant tokenCreationMin =  ((2**256) - 1) / 10**decimals;
