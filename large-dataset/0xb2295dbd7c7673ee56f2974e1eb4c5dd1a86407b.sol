...
tokenTransfer public bebTokenTransfer; //\u4ee3\u5e01 
   ...
   struct BebUser {
    ...
    uint256 ethExchuangeRate=218;//eth-usd
    ...
    uint256 SellBeb=10000000000000000000000000;//SellBeb MAX 10000BEB

    uint256 BuyBeb=10000000000000000000000000;//BuyBeb MAX 100000BEB
