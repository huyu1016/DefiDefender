...
contract SweeneyDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmNeCnSwuShnMgmkLtVKtfbuUq9p6Ag8pC4JA7JT3GXQhV";
    ...
    constructor(
    ) ERC721A("SweeneyDAO", "Sweeney", 100, maxSupply) {
    }
