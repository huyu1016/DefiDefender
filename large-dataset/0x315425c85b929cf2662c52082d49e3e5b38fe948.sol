...
contract AmouranthDAO is ERC721A, IERC2981, Ownable, ReentrancyGuard {
    using Counters for Counters.Counter;
    using Strings for uint256;

    Counters.Counter private tokenCounter;

    string private baseURI = "ipfs://QmPk3XUXnvGg6ikkSoQr8225kcnLHhk1ArfuqNAhFandQB";
    ...
    constructor(
    ) ERC721A("AmouranthDAO", "AMOURANTH", 100, maxSupply) {
    }
