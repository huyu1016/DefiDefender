 ...
 * @title HammerTokenstandard

 * @dev the interface of HammerTokenstandard

 */

contract HammerTokenstandard {
...
contract HammerToken is ERC20, HammerTokenstandard,Ownable {

    using SafeMath for uint256;



    string public name = "HammerToken";

    string public symbol = "HMRT";
