...

{
  ...
  string public constant version = "cafe-1.2";
...
// File: contracts/migration-artifacts/erxes/2020_DEC_11_FIX.sol
...
contract ERXES_2020_DEC_FIX is CAFE {

  string public constant version = "migration...";

  function migrate() external {

    require(msg.sender == control, "only control can call this function");

    buySlopeNum = 120;

    buySlopeDen = 100000000000000000000000000000000000000;

    equityCommitment = 1488;
