...
contract ElysiumClub is ERC721Enumerable, Ownable, RoyaltiesV2Impl {

    using SafeMath for uint256;
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    string private _dataHostBaseURI = "ipfs://QmWHx293w768mZkYnqVswPYVzWzUwjCK3qNfqQnYSpVsZ1/";
    string private _lockedDataHostBaseURI = "ipfs://QmbdjoBLUMCkqZKfXB7n8YSjkVYAPVxrX4UEMkFDgWHNSH/";
    string private _contractURI = "https://ipfs.io/ipfs/Qmer1bmCfytNAswiTey2jGxZBBf1NXVwPbUSZoQtzAXAMC";
    string private _placeHolderHash = "ipfs://QmSkArc6e1s7no6F1kEhgnoXQc6fqeaiNTfBxf5z66a2kJ";
    ...
    uint256 private _collabPrice = 400000000000000000;
