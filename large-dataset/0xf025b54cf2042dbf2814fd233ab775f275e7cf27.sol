...
======================= Quick Stats ===================
    ...
    => Total supply: 99,000,000 (99 Million)
...
contract QuantexToken is owned {
    ...
    string constant private _name = "Quantex Token";

    string constant private _symbol = "QTK";

    uint256 constant private _decimals = 18;

    uint256 private _totalSupply = 99000000 * (10**_decimals);         //99 million tokens
