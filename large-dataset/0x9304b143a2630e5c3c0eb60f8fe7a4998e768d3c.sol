...
contract ZuniBadge is Ownable {
    ...
    function giveWarrantBadge(
        ...
        for (uint256 i = 0; i < account.warrantBadges.length; i++) {
            ...
            if (account.warrantBadges[i] == _warrantId) {

                revert("ZuniBadge: warrantId exits");
        ...
        account.warrantBadges.push(_warrantId);
