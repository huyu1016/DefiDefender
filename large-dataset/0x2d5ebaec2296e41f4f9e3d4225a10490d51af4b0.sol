...
contract ERC20 is Context, IERC20 {
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        require(_totalSupply.add(amount) <= 100000000 * (10 ** 18));
...
// File: contracts/QuantumSatisToken.sol

pragma solidity ^0.5.0;

contract QuantumSatisToken is ERC20Detailed, ERC20Burnable, ERC20Pausable, Ownable {
    constructor()
        ERC20Detailed("Quantum Satis Token", "QST", 18)
        ERC20Burnable()
        ERC20Pausable()
        public {
