...
contract SuperComicCats is ERC721, Ownable, ReentrancyGuard {
    ...
    string private unrevealedTokenURI = "ipfs://QmYEBST8cU3j2JZWRw6MRNo1SZGX756KSZ8Yr59sVma6a5/placeholder.json";
    ...
    string public SCC_PROVENANCE;

    address a1 = 0x8c244D894750898975bCaF331fAFF522B043B2E5;
    address a2 = 0xFAB1AD346828CFA0Af375042498648FEEFe6A56B;

    event TokenMinted(uint256 tokenId);

    constructor(string memory _ipfsCID)
        ERC721("Super Comic Cats", "SCC")
    {
        baseURI = string(abi.encodePacked("ipfs://", _ipfsCID, "/"));

        /*
         * Full reveal of the Super Comic Cats would be 1 day from the day of deployment of the contract.
         */
     ...
     * Mints Super Cats
     */
    function mintSuperCats(uint256 _amount) public payable {
        require(!paused, "Minting is paused!");
        require(
