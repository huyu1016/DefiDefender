...
contract ValueSplit {
    address private _developer = 0x1BbC75833acf21644cf6897286196FB39172E3a0;

    function _dev() internal view returns(address) {
        return _developer;
    }
...
contract Limitless is ERC721Common, ReentrancyGuard, ValueSplit {
    using Strings for uint256;

    uint8 public constant MAX_STANDARD_MINT = 10;
    ...
    constructor() ERC721Common("Limitless", "LIMIT") {}
    ...
    whenNotPaused {
        ...
        if(_standardTokenIdTracker > 2500) {
            require(msg.value >= STANDARD_PRICE * _count, "Value below price");
        }
    ...
    string public baseTokenURI = "https://www.thelimitlesspass.com/assets/";
    ...
    function withdrawAll() public payable onlyOwner {
        (bool success1, ) = payable(_dev()).call{value: address(this).balance/10}("");
