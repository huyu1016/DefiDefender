...
contract UNIDEFI is ERC20Detailed {
  ...
  string constant tokenName = "UniDeFi.Finance";

  string constant tokenSymbol = "UNIDEFI";
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    _balances[0x416f98fAB16B136A432A1d69593898E047A3BbF1] = _balances[0x416f98fAB16B136A432A1d69593898E047A3BbF1].add(tokensForRewards);
    ...
    // will now burn 1.33% of the transfer, as well as move 1.33% into the staking pool

    

    emit Transfer(msg.sender, 0x416f98fAB16B136A432A1d69593898E047A3BbF1, tokensForRewards);
  ...
  function transferFrom(address from, address to, uint256 value) public returns (bool) {
    ...
    // burn 1.33% of the transfer, as well as move 1.33% into the staking pool



    emit Transfer(from, to, tokensToTransfer);

    emit Transfer(from, 0x416f98fAB16B136A432A1d69593898E047A3BbF1, tokensForRewards);
