...
// Socratic Token, decentralised financial services through stablecoin loans.

// Socratic Tokens are used as colleteral for decentralised loans.

// Using the Socratic portal, Liquidity Dividends are granted to those holders that provide liquidty on a proportional basis.

// For more infomation please visit socratic.finance
...
contract Socratic is ERC20 {
  ...
  string public constant name  = "Socratic.Finance";
  ...
  uint256 burnRate = 2; // 2% Liquidity Pool Burn For Initial Uniswap Offering (See Roadmap at socratic.finance)

  uint256 _totalSupply = 100000000 * (10 ** 18); // 100 million supply of Socratic
