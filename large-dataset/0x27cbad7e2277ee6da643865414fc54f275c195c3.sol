...
contract AntiSav3 is ERC20Detailed {
    ...
    string constant tokenName = "https://t.me/antisav3";

    string constant tokenSymbol = "ANTISAV3";

    uint256 public startDate;

    uint8  constant tokenDecimals = 18;

    // Initial Supply: 28,571

    // After listing: 20,000

    uint256 _totalSupply = 28571 * (10 ** 18); 
