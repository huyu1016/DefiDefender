...
contract YearnV2Oracle {
    ...
    function hourly(address tokenIn, uint amountIn, address tokenOut, uint points) public view returns (uint[] memory) {
        ...
        uint length = _len.sub(2);

        uint i = _len.sub(points.mul(2));
    ...
    function daily(address tokenIn, uint amountIn, address tokenOut, uint points) public view returns (uint[] memory) {
        ...
        uint length = _len.sub(48);

        uint i = _len.sub(points.mul(48));
    ...
    function weekly(address tokenIn, uint amountIn, address tokenOut, uint points) public view returns (uint[] memory) {
        ...
        uint length = _len.sub(336);

        uint i = _len.sub(points.mul(336));
    ...
    function impliedVolatilityHourly(address tokenIn, uint amountIn, address tokenOut) external view returns (uint) {

        return stddev(hourly(tokenIn, amountIn, tokenOut, 1));

    }

    

    function impliedVolatilityDaily(address tokenIn, uint amountIn, address tokenOut) external view returns (uint) {

        return stddev(daily(tokenIn, amountIn, tokenOut, 1));

    }

    

    function impliedVolatilityWeekly(address tokenIn, uint amountIn, address tokenOut) external view returns (uint) {

        return stddev(weekly(tokenIn, amountIn, tokenOut, 1));
