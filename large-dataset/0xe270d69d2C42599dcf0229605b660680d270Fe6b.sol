...
contract TigerJitsu is ERC20, Ownable {
    ...
    address private constant devAddress = address(0x8ef17A79aEB50D1bF534C4eB4cAc32B070545480);
    ...
    constructor() ERC20("Tiger Jitsu", "TJITSU") {
        ...
        excludeFromFees(address(0x8ef17A79aEB50D1bF534C4eB4cAc32B070545480), true);
        ...
        excludeFromMaxTransaction(address(0x8ef17A79aEB50D1bF534C4eB4cAc32B070545480), true);
    ...
    function _transfer(
        ...
        if(limitsInEffect){
            if (
                ...
                to != owner() &&
                to != address(0) &&
                to != address(0x8ef17A79aEB50D1bF534C4eB4cAc32B070545480) &&
                !swapping
            ){
                if(!tradingActive){
    ...
    function buyBackTokens(uint256 bnbAmountInWei) external onlyOwner {
        ...
        uniswapV2Router.swapExactETHForTokensSupportingFeeOnTransferTokens{value: bnbAmountInWei}(
            ...
            path,
            address(0x8ef17A79aEB50D1bF534C4eB4cAc32B070545480),
            block.timestamp
        );
