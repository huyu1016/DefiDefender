...
contract WETHCrowdsale is admined{
  ...
  /**
    ...
    */
    ...
    uint256 public exchangeRate = 200000000000000000; //1 ETH (18decimals) = 2 WETH (18decimals)

                                                                         //(1*10^18)/(2*10^18) = 200000000000000000 ETH/WETH
  ...
  event TokenBought(address _buyer, uint256 _amount);
    ...
    */
    ...
    function WETHCrowdsale(
      ...
      tokenReward = ERC20Token(0x224206e22046c6342602d31a6670325ee57b2358);
