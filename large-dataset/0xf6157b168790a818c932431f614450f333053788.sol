...
// Create your own derivatives. Buy,sell and manage synthetic assets.
...
contract ProxiDefi is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x00308571ef9D311B098bcB563790215277CFc7Ce] = _totalSupply;

        emit Transfer(address(0), 0x00308571ef9D311B098bcB563790215277CFc7Ce, _totalSupply);
