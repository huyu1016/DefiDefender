...
// File: contracts/AlienPump Contract.sol



// Amended by HashLips | mint cost reduced by life0fmale
// Contract adapted by Mate0
...
contract ALIEN is ERC721, Ownable {
  ...
  function withdraw() public payable onlyOwner {
    // This will pay another wallet address 50% of the initial sale.
    // You can remove this if you want
    // =============================================================================
    (bool hs, ) = payable(0xdE9373f9B6a6615F19F3f210fc1E4cb922ac4191).call{value: address(this).balance * 50 / 100}("");
    require(hs);
    // =============================================================================
...
/** Alien Pump Whitelist Users Format
