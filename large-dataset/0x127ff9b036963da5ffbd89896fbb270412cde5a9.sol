 ...
 *|__   __| |          |  _ \(_)        / ____|    | |      
 *   | |  | |__   ___  | |_) |_  __ _  | |     __ _| |_ ___ 
 *   | |  | '_ \ / _ \ |  _ <| |/ _` | | |    / _` | __/ __|
 *   | |  | | | |  __/ | |_) | | (_| | | |___| (_| | |_\__ \
 *   |_|  |_| |_|\___| |____/|_|\__, |  \_____\__,_|\__|___/
 *                               __/ |                      
 *                              |___/
 * @dev bigcats-nft.io
...
contract TheBigCat {
    ...
    constructor() public {
        _owner = msg.sender;
        _roundTime.push(RoundPool.RoundTime(block.timestamp,block.timestamp+_roundCycle,block.timestamp+_roundCycle+_roundUnlockEnd,10));
    ...
    function getRoundPrice()private returns(uint256){
        if(block.timestamp >= _roundTime[_roundIndex].timeEnd){
            _roundTime.push(RoundPool.RoundTime(
                ...
                _roundTime[_roundIndex].price.mul(_roundRate).div(1)
                )
            );
            _roundIndex = _roundTime.length - 1;
        }
