...
// File: DegenAlertsLifetimeAccessNFTV1 .sol
...
contract DegenAlertsLifetimeAccessNFT is ERC721Enumerable, Ownable 
{
    using Strings for string;

    uint public constant MAX_TOKENS = 50;
    uint public PRESALE_LIMIT = 50;
    ...
    string private _baseTokenURI = "ipfs://QmVLjxHj9h6QkBJ3LiPeW8LBWzcKN4qPPJbNdtRfX1iJ5j/";
    string public notRevealedUri;
    bytes32 root;
    mapping(address => uint) public addressMintedBalance;

    constructor() ERC721("Degen Alerts Lifetime Access", "DALA") {}
