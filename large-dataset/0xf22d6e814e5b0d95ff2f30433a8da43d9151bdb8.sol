...
contract DOSTToken is VestedToken {
    ...
    function DOSTToken() public {
        ...
        grantVestedTokens(toAddress, totalSupply.div(100).mul(35), now, now, now, false, false, true);
        grantVestedTokens(toAddress, totalSupply.div(100).mul(20), now, now + 365 days, now + 365 days, false, false, true);
        grantVestedTokens(toAddress, totalSupply.div(100).mul(15), now, now + 730 days, now + 730 days, false, false, true);
        ...
        grantVestedTokens(toAddress, totalSupply.div(100).mul(30), startMine, startMine, finishMine, false, false, false);
    }
