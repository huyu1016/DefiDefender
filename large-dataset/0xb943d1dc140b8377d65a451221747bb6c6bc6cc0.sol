...
contract PriceOracleProxy is PriceOracle {
    ...
    /**
     * @param comptroller_ The address of the active comptroller, which will be consulted for market listing status.
     * @param v1PriceOracle_ The address of the v1 price oracle, which will continue to operate and hold prices for collateral assets
     * @param cEtherAddress_ The address of the cEther contract, which will return a constant 1e18, since all prices relative to ether
     * @param cUsdcAddress_ The address of the cUSDC contract, which will be read from a special oracle key
     * @param cDaiAddress_ The address of the cDAI contract, which will be read from a special oracle key
     */
    constructor(address comptroller_, address v1PriceOracle_, address cEtherAddress_, address cUsdcAddress_, address cDaiAddress_) public {
    ...
    function getUnderlyingPrice(CToken cToken) public view returns (uint) {
        ...
        } else if (cTokenAddress == cDaiAddress) {
            // read from hand picked key
