...
// hevm: flattened sources of src/lender/fabs/assessor.sol
...
contract Assessor is Auth, FixedPoint, Interest {
    ...
    TrancheLike_1     public seniorTranche;
    TrancheLike_1     public juniorTranche;
    ...
    function depend(bytes32 contractName, address addr) public auth {
        if (contractName == "navFeed") {
            ...
            seniorTranche = TrancheLike_1(addr);
        } else if (contractName == "juniorTranche") {
            juniorTranche = TrancheLike_1(addr);
