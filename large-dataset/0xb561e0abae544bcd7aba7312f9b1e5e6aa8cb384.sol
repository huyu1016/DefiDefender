...
contract CREDIT is ERC20Detailed, ERC20Pausable, ERC20Burnable, MinterRole {
  ...
  mapping (address => bool) public frozenAccount;
    ...
    event MintedCredit(address indexed _to, string _basicUserId, uint256 _amount, uint256 _creditAmount);
    ...
    function mint(address to, string memory _basicUserId, uint256 _amount, uint256 _creditAmount) public onlyMinter returns (bool) {

        _mint(to, _creditAmount);

        emit MintedCredit(to, _basicUserId, _amount, _creditAmount);
