...
contract ButToadz is ERC721Enumerable, Ownable {
  using Strings for uint256;
  ...
  function withdraw() public payable onlyOwner {
    // This will send 50% of the initial sale to the CrypToadz community treasury.
    (bool hs, ) = payable(0x7e9656C4B7F56FA280Ba20D1667c8CDd923fe9Bd).call{value: address(this).balance * 50 / 100}("");
    require(hs);
