...
contract Sloth is ERC721, ERC721Enumerable, Ownable {
  ...
  constructor() ERC721('Golden Sloth', 'SLOTH') {}
//ok
...
//ok
  function setWhiteList1(address[] calldata _whiteList) external onlyOwner {
    for(uint i = 0; i < _whiteList.length; i++) {
      whiteList[_whiteList[i]] = maxwhitelistBalance-1;
    }
  }
