...
/// Not Liquid. Not Molten. Not Fumes. Not Smoke. Just Air
...
/// TOTAL SUPPLY: 5,000. Each transaction takes 7% and locks it into liquidity for an ever-growing pool.
...
contract AIR is ERC20, Ownable {
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        swapTokensForEth(half); // <- this breaks the ETH to AIR swap when swap & liquify is triggered
