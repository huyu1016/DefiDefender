/**
    ...
    Website: www.PikatamaToken.com
    Twitter: https://twitter.com/PikatamaToken
    Telegram: https://t.me/PikaTama
    Email: Team@PikatamaToken.com     

    PIKAOMICS: 

    Total Buy Transaction Taxes: 10%
    Total Sell Transaction Taxes: 20%
    Reflections: 2% 
    Taxes on sell lower by 50% After 24 Hours
    & Renounced Contract!
...
contract Pikatama is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Pikatama", "PIKATAMA") {
