...
contract PositionTokenLogicV2_1 is SplittableTokenV2 {
    ...
    address internal currentOracle;

    modifier fixedSaneRate

    {

        currentOracle = IBZx(bZxContract).oracleAddresses(bZxOracle);



        IBZxOracle(currentOracle).setSaneRate(
        ...
        IBZxOracle(currentOracle).clearSaneRate(
