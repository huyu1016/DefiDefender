...
contract MiceRaceCrowdsale is RefundablePostDeliveryCrowdsale, Ownable {
     ...
     * @dev Must be called by owner after the crowdsale opens in order to start receiving funds.

     * Funds will not be accepted before this method is sucessfully executed.

     * Contract must own preset amount of tokens while calling this method.
     ...
     * @dev Extend parent behavior requiring purchase to respect following rules:

     * - sale has been started by owner

     * - invested amount must not be lower than minimal investment amount

     * - invested amount must not exceed hard cap
     ...
     * @dev This method has to take into consideration wheter the soft cap has been reached.

     * In case invested amount would overflow soft cap, it has to use both respective exchange rates.
     ...
     * @dev Only possible to call by owner after crowdsale successfully ends.
