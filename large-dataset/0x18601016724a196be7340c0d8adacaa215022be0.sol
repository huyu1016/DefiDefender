...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[2] memory weiAmountBounds = [uint(1000000000000000000000),uint(5000000000000000000)];

        uint[2] memory weiAmountRates = [uint(0),uint(300)];
...

{
    ...
    constructor(MintableToken _token) public
        ...
        Crowdsale(2400 * TOKEN_DECIMAL_MULTIPLIER, 0xDB3cdAF346dA8F7950EafFCcC343a600841c702d, _token)

        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1609527600)

        CappedCrowdsale(1250000000000000000000)
    ...
    function init() public onlyOwner {
        ...
        address[5] memory addresses = [address(0xedf47a95171bfe6f00da44bbd935f6ac8d5c044c),address(0xd6169a40bbc913bb7c34e769261b3dd2315f20bb),address(0x71699cb7353623806dcb512c52e893972419ddd0),address(0x613ad1bb91fb23d92021f73e3469859f1cd76dfd),address(0x3d1ec0f562235efa41e832ebd67e2699e3e6e5b6)];

        uint[5] memory amounts = [uint(900000000000000000000000),uint(1000000000000000000000000),uint(600000000000000000000000),uint(1500000000000000000000000),uint(3000000000000000000000000)];

        uint64[5] memory freezes = [uint64(0),uint64(0),uint64(0),uint64(1617145201),uint64(0)];
