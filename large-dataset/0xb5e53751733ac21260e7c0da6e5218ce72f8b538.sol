...
// File: contracts/SpaceBlazers.sol
...
contract SpaceBlazers is ERC721A, Ownable {
    using SafeMath for uint256;
    using Strings for uint256;
    uint256 public constant MAXASSETS = 3333;
    uint256 public constant freeMints = 1700;
    ...
    constructor(string memory baseURI, address _proxyRegistryAddress) ERC721A("Space Blazers", "SBLZR") {
        setBaseURI(baseURI);
        isSaleActive = false;
