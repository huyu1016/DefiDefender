...
contract YefamFinanceV2 is ERC20, ERC20Detailed {

  using SafeMath for uint;

  mapping (address => bool) public YFFholders;

  constructor () public ERC20Detailed("yefam.finance", "YFF", 18) {

      _initMint( msg.sender, 10000*10**uint(decimals()) );

      YFFholders[msg.sender] = true;
