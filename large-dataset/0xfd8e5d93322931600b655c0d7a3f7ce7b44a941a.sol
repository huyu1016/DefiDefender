...
contract Configurable {            
    ...
    uint256 public constant cap = 777777;

    uint256 public constant basePrice = 100; // tokens per 1 ether

    uint256 public tokensSold = 0;

    

    uint256 public constant tokenReserve = 777777;
...
contract T7TokenSmart is CrowdsaleToken {

    string public constant name = "T1T7Token1";

    string public constant symbol = "T1T7T1";
