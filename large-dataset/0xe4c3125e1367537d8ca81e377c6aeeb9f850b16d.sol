 ...
 * @info: Lyra Protocol is an Aura/RFI Fork with a twist.
...
contract LYRA is Context, IERC20, Ownable {
    ...
    string private _name = "LYRA";

    string private _symbol = "LYR";
    ...
    uint256 public rebalanceInterval = 60 minutes;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(
            ...
            "LYRA: Uniswap router cannot be excluded."

        );

        require(account != address(this), 'LYRA: The contract it self cannot be excluded');

        require(!_isExcluded[account], "LYRA: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        ...
        require(_isExcluded[account], "LYRA: Account is already included");
    ...
    function _transfer(
        ...
        //@dev Limit the transfer to 400 tokens for first 5 minutes

        require(now > liquidityAddedAt + 5 minutes  || amount <= 400e9, "You cannot transfer more than 400 tokens.");
