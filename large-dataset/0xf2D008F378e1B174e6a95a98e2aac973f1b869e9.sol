...
// File: contracts/fodao.sol

/**
 * ལྟ་བ་དབང་ཕྱུག་རྗེ་བཙུན་སྒྲོལ་མ། ཉམས་ལེན་ཟབ་པའི་ཕ་རོལ་ཏུ་ཕྱིན་པ་ཕ་རོལ་ཏུ་ཕྱིན་པ་མང་བའི་དུས་ཀྱི་རྩོལ་བ་དམར་རྗེན་དུ་མངོན་པ་དང་ཕྱི་ནས་རྒྱལ་མཚམས་ཟུང་འབྲེལ་ཀུན་ཏུ་སྟོང་། ཚད་ཐམས་ཅད་སྡུག་བསྔལ་སྐེག
 */
pragma solidity >=0.4.22 <0.9.0;
...
contract FoDaoEth is INft, Context, ERC165, IERC721, IERC721Metadata, Ownable {
    ...
    // གི་ཞུན་ཐིགས། ཡོད་ཚད་སེམས་གྲིབ་མ་ཕན་ཚུན་མི་སྐྱེ་མི་ཆད་མེད་དྲེག་མི་གཙང་མི་ཇེ་ཉུང་དུ་མི་འགྲོ་བ།
    ...
    uint public buy_limit_per_address = 5;

    uint public sell_begin_time = 0;

    constructor(string memory name, string memory symbol, string memory baseUrl)
    {
        _name = name;
        _symbol = symbol;
        setBaseURI(baseUrl);
    ...
    // གི་ཞུན་ཐིགས། ཁ་དོག་མི་ལོག་སྟོང་། སྟོང་བར་མི་ཁ་ཏོག་མི་འདྲ་བ། མདོག་སྟེ་སྟོང་བ། སྟོང་པ་ཉིད་གཟུགས་སོ་ཐེབས་པ་འདོད་བྱ་སྤྱོད་ས་རྒྱུ་ལས་མ་འདའོ། །
