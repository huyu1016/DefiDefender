 ...
 *
 *  HIGH RETURN! Get 0.4% - 0.27% per hour (9.6% - 6.5% per day)
 *
 ...
 *      >= 5000                   ~6.5%
 *
 * With the increase in the balance of the smart contract, the interest rate decreases, which will have a positive impact on the life expectancy of the project!
 * 
 *  LOW WITHDRAWAL FEES! Advertising 4%-10%, charity 1%
 *
 *  LONG LIFE! Maximum return is bounded by double profit(x2). Anyone has right to be rich!
 *
...
contract DoubleProfit {
    ...
    address private constant ADDRESS_ADV_FUND = 0x349DaB3F9D038f806FF8f5B5AaD6135CA518B953;
    //wallet for a reserve fund
    address private constant ADDRESS_CHARITY_FUND = 0x98Bd5A78eA2A3C7CC55309A43520F535365db2DC;
    ...
    uint private constant PERCENT_START = 400;
    uint private constant PERCENT_LOW = 380;
    uint private constant PERCENT_MIDDLE = 320;
    uint private constant PERCENT_HIGH = 270;
    ...
    //interest rate decrease steps
    uint private constant STEP_HIGH = 1000 ether;
    uint private constant STEP_MIDDLE = 2500 ether;
    uint private constant STEP_LOW = 5000 ether;
    ...
    function returnDeposit() isIssetUser private {
        //percentWithdrawn already include all taxes for reserve and ads
