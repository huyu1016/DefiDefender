...
contract Surviveth is Context, AccessControlEnumerable, ERC721Enumerable, ERC721URIStorage, Ownable {
  using Counters for Counters.Counter;
  Counters.Counter public _tokenIdTracker;

  string private _baseTokenURI = "https://surviveth.herokuapp.com/api/token/";
  uint private _price;
  uint private _max;
  ...
  function contractURI() public pure returns (string memory) {
		return "https://metagascar.com";
	}

  function setBaseURI(string memory baseURI) external onlyOwner() {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Surviveth: must have admin role to change base URI");
    _baseTokenURI = baseURI;
  }

  function setTokenURI(uint256 tokenId, string memory _tokenURI) external onlyOwner() {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Surviveth: must have admin role to change token URI");
    _setTokenURI(tokenId, _tokenURI);
  }

  function setPrice(uint mintPrice) external onlyOwner() {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Surviveth: must have admin role to change price");
    _price = mintPrice;
  }
  ...
  function mint() public payable {
    ...
    require(msg.value == _price, "Surviveth: must send correct price");
    require(_tokenIdTracker.current() < _max, "Surviveth: all Surviveth have been minted");
  ...
  function mineReserves(uint _amount) public {
    require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Surviveth: must have admin role to mine reserves");
  ...
  function flipSaleState() public onlyOwner() {
   require(hasRole(DEFAULT_ADMIN_ROLE, _msgSender()), "Surviveth: must have admin role to flip sales");
