...
contract ITSX is Ownable {

  using SafeMath for uint256;



  string public constant name = "IterationX";

  string public constant symbol = "ITSX";

  uint256 public constant decimals = 18;

  uint256 private constant _maximumSupply = 10000000 * 10 ** decimals;
