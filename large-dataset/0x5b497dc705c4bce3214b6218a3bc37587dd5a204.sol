...
contract PacificProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Pacific Protocol";
    ...
    uint256 internal _tokenTotal = 1_000_000e18;
    ...
    uint256 public _liquidityFee = 750;
