...
contract PositionTokenLogicV2 is SplittableTokenV2 {
...

    {
        ...
        if (tokenAddress == tradeTokenAddress)
...

    {
        ...
        if (maxSendAmount != 0 && maxSendAmount < assetBalance) {

            assetBalance = maxSendAmount;
        ...
        IBZx(bZxContract).closeLoanSimple(
...

    {
        ...
        uint256 assetBalance = ERC20(tradeTokenAddress).balanceOf(address(this));
