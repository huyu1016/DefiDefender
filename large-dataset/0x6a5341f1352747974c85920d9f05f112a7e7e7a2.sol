...
contract ZionProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Zion Protocol";

    string private _symbol = "ZION";
    ...
    uint256 public _rebalanceCallerFee = 2500;
    ...
    uint256 public minTokensBeforeSwap = 500;

    uint256 public minEthBeforeSwap = 500;
    ...
    uint256 public rebalanceInterval = 59 minutes;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(
            ...
            "ZION: Uniswap router cannot be excluded."

        );

        require(account != address(this), 'ZION: The contract it self cannot be excluded');

        require(!_isExcluded[account], "ZION: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        ...
        require(_isExcluded[account], "ZION: Account is already included");
    ...
    function _transfer(
        ...
        //@dev Limit the transfer to 450 tokens for first 5 minutes

        require(now > liquidityAddedAt + 6 minutes  || amount <= 450e9, "You cannot transfer more than 450 tokens.");
