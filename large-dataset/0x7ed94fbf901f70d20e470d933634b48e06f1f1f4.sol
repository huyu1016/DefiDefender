...
// website  : https://Scheme.network 

// twitter  : https://twitter.com/SchemeNetwork

// medium   : https://medium.com/@schemeNetwork

// telegram : https://t.me/SchemeNetwork
...
contract Owned {
    ...
    address public privatesaleOwner;
    ...
    constructor() public {
        ...
        owner = 0x8bc1683Fe8AafB5355Cee8dcd1ea6321E9a92125;

        liquidityOwner = 0x97d402Cb22751A41381dF181d3B04CD7DCf55d3C;

        teamOwner = 0xF81F6d53cd08bb64924187787d5d437f01e131cd;

        marketingOwner = 0x7679A54301a58E35801dCAbb450bD330d01cD0bD;

        stakingOwner = 0x4246DE294A55d41099E49Eda1681c1D453294aa5;

        privatesaleOwner = 0x7b49295EF961ca0b2F5e65B52559Ab44f4109229;

        airdropOwner = 0x2Efe1F402C4e8dCfc3B01fC7dF305924EE19b090;
...
contract SchemeNetwork is ERC20Interface, Owned {
  ...
  mapping(address => uint) buylimit;
    ...
    constructor() public {
        ...
        icoSupply = 1800000 * 10**uint(decimals);

    liquiditySupply = 1000000 * 10**uint(decimals);

        teamSupply = 600000 * 10**uint(decimals);

        marketingSupply = 300000 * 10**uint(decimals);

        stakingSupply = 3000000 * 10**uint(decimals);

        privatesaleSupply = 200000 * 10**uint(decimals);

        airdropSupply = 100000 * 10**uint(decimals);
        ...
        balances[stakingOwner] = stakingSupply;

        balances[privatesaleOwner] = privatesaleSupply;

        balances[airdropOwner] = airdropSupply;



      

        RATE = 3333; // 1 ETH = 3333 SCHM 
        ...
        emit Transfer(address(0), stakingOwner, stakingSupply);

        emit Transfer(address(0), privatesaleOwner, privatesaleSupply);

        emit Transfer(address(0), airdropOwner, airdropSupply);
