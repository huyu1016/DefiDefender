/*** Part of the SimpDAO family ***/
                  /** Simping as a Service **/

/** Keep an eye out for SimpDAO.io for when SimpDAO goes live. **/
    ...
    ControlledAccess
{
    ...
    uint256 private publicStart = 1642822313;
    ...
    event welcomeSimp(uint256 indexed id);
    ...
    function setStartTimes(uint256 _publicStart)
        public
        onlyOwner
    {
    ...
    /**
     * @notice Admin Mint. Generally for collaborations etc.
     */
    function adminMint(uint256 _amount, address receiver) public payable onlyOwner nonReentrant {
        uint256 total = totalSupply();
        require(total + _amount <= MAX_ELEMENTS, "Max limit");
        _mintAmount(_amount, receiver);
    }
    ...
    function _mintAnElement(address _to) private {
        ...
        emit welcomeSimp(_tokenIdTracker.current());
    }
