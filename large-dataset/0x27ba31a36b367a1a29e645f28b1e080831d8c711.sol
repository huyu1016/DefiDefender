...
// File: contracts/SacToken.sol

/*
 * SacToken is a standard ERC20 token with some additional functionalities:
...
contract SacToken is StandardToken, BurnableToken, Ownable {
	...
	uint256 public constant INITIAL_SUPPLY = 48000000000 * (10 ** uint256(decimals));
	uint256 public constant TOKEN_OFFERING_ALLOWANCE = 19200000000 * (10 ** uint256(decimals));
	...
	*/
	function SacToken(address admin) public {
	...
	* @param value Amount of sactokens to send
	*/
