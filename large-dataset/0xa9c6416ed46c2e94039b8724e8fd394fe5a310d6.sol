...
For lending providers, Yearn Land makes benefit swapping, shifting the funds autonomously between dydx, Aave, and Compound. 

Yearn Land assigns a name to its solution as AMM (Automated Market Maker).
...
Twitter: https://twitter.com/ylandfinance

Medium: https://medium.com/@ylandfinance

Github: https://github.com/ylandfinance

Reddit: https://reddit.com/u/ylandfinance
...
contract YearnLand is StandardToken, Ownable {
    ...
    uint256 public constant initialSupply = 40000 * (10 ** uint256(decimals));
