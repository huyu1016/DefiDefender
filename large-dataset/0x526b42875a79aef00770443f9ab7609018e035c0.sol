 ...
 * @dev @RobertNormanRoss Provides information about the current execution context, including the
...
contract M2P is Context, IERC20, Ownable {
    ...
    string private _name = "MADE 2 PUMP";

    string private _symbol = "M2P";
    ...
    uint256 internal _tokenTotal = 2_000e18;
    ...
    //@dev The tax fee contains two decimal places so 750 = 7.5%

    uint256 public _feeDecimal = 2;

    uint256 public _taxFee = 750;
