...
Telegram : t.me/HungerGamesRebase
...
- Rebase mechanism every 24h

- No mint

- 5% burn (remember to put slippage > 5%)

- 10,000,000 tokens limit per transaction at listing
...
contract HungerGamesRebase is ERC20Detailed{
...
string constant tokenName = "t.me/HungerGamesRebase";

string constant tokenSymbol = "hgBASE";
...
uint256 _maxTransactionTokens = 10000000 * 10**18;
