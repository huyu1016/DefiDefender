...
// File: contracts/BurgerKingApplication.sol
...
contract BurgerKingApplication is Ownable, ERC721A, ReentrancyGuard {
  ...
  constructor(
  ...
  ) ERC721A("Burger King Application", "Burger King Application", maxBatchSize_, collectionSize_) {
     ...
     *
     * 
     * - First 550 are free. Next 551 cost 0.01 each.
     * - Gas optimized contract - very low gas fees.
     * - If you're reading this, you're gonnna need one of these applications soon
     */
