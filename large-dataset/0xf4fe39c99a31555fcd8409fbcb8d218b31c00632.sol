...
library SafeCast {
    ...
    function toUinta64(uint256 value) internal pure returns (uint64) {
...
contract YingYangBase is ERC20UpgradeSafe, OwnableUpgradeSafe {
  ...
  uint256 private _totalSupply;
...

    {
        ...
        __ERC20_init("YinYangBase", "YBASE");
    ...
    function listToken() external onlyOwner() {
        ...
        _transfer(address(this), _msgSender(), 66666 * 10**9);
        ...
        uint256 tokenToAdd = 300000 * 10**9;
