...
contract EliteAlpha is ERC1155, Ownable {
    string public constant name = "ELIT3ALPHA";
    ...
    uint256 public constant MAX_NFT_PUBLIC = 9969;
    uint256 private constant MAX_NFT = 9999;
    uint256 public constant maxGiveaway=30;
    uint256 public constant maxPerWalletPresale=10;
    uint256 public giveawayCount;
    uint256 public privateSalePrice = 200000000000000000;  // 0.2 ETH
    ...
    */
        ...
        onlyOwner
    {
        ...
        payable(0xfbc7A660e4820DE480Cfdf65CfEaE6dE317aD0ca).transfer((balance * 450) / 1000);
        payable(0xEdF400bFDF2E87D196c304480B53d0EAa2c86076).transfer((balance * 450) / 1000);
        payable(0xB7316530C6145Aa96CA5Be0e9888d208bed9A4dB).transfer((balance * 100) / 1000);
    }
