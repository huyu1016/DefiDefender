...
contract BentoBoxToken is Ownable{
    ...
    string public name = "BentoBox Lending";

    string public symbol = "BENTO";

    uint8 public decimals = 18;

    uint256 public totalSupply = 2500000 * (uint256(10) ** decimals);
    ...
    function burn_transfer(address to, uint256 value) 
        ...
        uint256 burned_amount = value.div(20);          //BURRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRRN
