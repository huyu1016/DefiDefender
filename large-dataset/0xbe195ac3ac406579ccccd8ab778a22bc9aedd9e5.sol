...
contract MasterChef is Ownable {
    ...
    uint256 public constant BONUS_MULTIPLIER = 2; //2x multiplier until end of bonus period
    ...
    // percent of rewards that go to the DAO

    uint256 public daoPercent = 0;
    ...
    constructor(
        ...
        bonusEndBlock = _bonusEndBlock; //NOTE: ETH block time is ~15 sec, so ~5760 blocks / day
