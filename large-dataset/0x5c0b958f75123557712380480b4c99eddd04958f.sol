/**
 * Source Code first verified at https://etherscan.io on Saturday, January 20, 2018
 (UTC) */
...
contract CryptoShowCoin is ERC20Token
{
    ...
    function CryptoShowCoin()
    {
        ...
        balances[msg.sender] = 2000000000000000;  // Передача создателю всех выпущенных монет
        name = 'CryptoShowCoin';
        decimals = 8;
        symbol = 'CSC';
