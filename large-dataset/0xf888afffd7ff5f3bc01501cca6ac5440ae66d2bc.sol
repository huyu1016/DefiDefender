...
contract KperNetwork is ReentrancyGuard {
    ...
    /// @notice Kper Helper to set max prices for the ecosystem
    ...
    string public constant name = "KperNetwork";
     ...
     * @notice Allows governance to change the KperHelper for max spend

     * @param _kprh new helper address to set

     */

    function setKperHelper(IKperNetworkHelper _kprh) external {

        require(msg.sender == governance, "setKperHelper: !gov");
