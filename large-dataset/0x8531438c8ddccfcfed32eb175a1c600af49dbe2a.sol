...
contract EVEPresale is Context, ReentrancyGuard {
    ...
    uint totalNumberForPresale = 1275; 

    uint maxEthHardCap = 75; 
    ...
    function buyTokens() public payable nonReentrant {
        ...
        //require(msg.value <= 1.51 ether, "You sent more than 1.5 ETH");

        require(msg.value <= 1.5 ether, "You sent more than 1.5 ETH");



        //3V3: 75 ETH presale cap

        require(ethSent < 75 ether, "Hard cap reached");

        require (msg.value.add(ethSent) <= 75 ether, "Hardcap reached");



        //3V3: 1.5 ETH limit

        require(ethSpent[msg.sender].add(msg.value) <= 1.5 ether, "You cannot buy more than 1.5 ETH");
