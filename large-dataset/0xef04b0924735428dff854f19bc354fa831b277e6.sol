...
$FLIPPER is an ethereum blockchain smart contract that makes investing and donating to charity a safe and transparent activity.
...
contract FLIPPER is ERC20, Ownable {
    ...
    constructor() ERC20("FLIPPER", "FLIPPER") {
