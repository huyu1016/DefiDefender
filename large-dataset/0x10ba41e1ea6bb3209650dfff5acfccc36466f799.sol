...
* Copyright (c) 2019 Token Factory Switzerland AG 
...
contract TokenizedProperty is DividendDistributingToken, ERC20Detailed, Ownable {
  ...
  LandRegistryProxyInterface public registryProxy = LandRegistryProxyInterface(0xE89fbb3B16aED579D111B1AEDa0BA249fD43d1B2);  // 0x0f5Ea0A652E851678Ebf77B69484bFcD31F9459B;

  WhitelistProxyInterface public whitelistProxy = WhitelistProxyInterface(0x71B1b3551b1728176393a113303BA90b7897f5c2);  // 0xEC8bE1A5630364292E56D01129E8ee8A9578d7D8;
  ...
  function mint(address _to, uint256 _value) public isValid onlyOwner returns (bool) {  // equity dilution
