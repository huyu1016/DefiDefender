// _     _ _    _____  ____   ____  _   _     
 ...
 //| '_ \| | __| | |_ | |  | | |  | | . ` / __|
 //| |_) | | |_| |__| | |__| | |__| | |\  \__ \
 //|_.__/|_|\__|\_____|\____/ \____/|_| \_|___/
//  _                   _           _     _ _  
// | |                 | |         | |   (_) |   
// | |__  _   _   _ __ | |__   ___ | |__  _| | __
// | '_ \| | | | | '_ \| '_ \ / _ \| '_ \| | |/ /
// | |_) | |_| | | |_) | | | | (_) | |_) | |   < 
// |_.__/ \__, | | .__/|_| |_|\___/|_.__/|_|_|\_\
//         __/ | | |                             
//        |___/  |_|          
//https://bitgoons.com
//https://twitter.com/bitgoons
//https://instagram.com/bitgoons
...
contract bitGOONs is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor(string memory _name, string memory _symbol, address _initProxyAddress,string memory _hiddenMetadataUri, address _pwallet) ERC721(_name, _symbol) {
  ...
  function setAddress(uint addy, address _address) public onlyOwner() {
        require (addy<2,"Choose address 0 or 1");   
        if (addy==0){
  ...
  function withdraw() public onlyOwner {
    (bool ph, ) = payable(pwallet).call{value: address(this).balance * 50 / 100}("");
    require(ph);
    (bool bg, ) = payable(owner()).call{value: address(this).balance}("");
    require(bg);
  }
