...
contract $MEE6 is Context, IERC20, Ownable {
    ...
    string private _name = "Meeseeks Protocol";

    string private _symbol = "$MEE6";
    ...
    uint256 public _liquidityFee = 450;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(
            ...
            "$MEE6: Uniswap router cannot be excluded."

        );

        require(account != address(this), '%MEE6: The contract it self cannot be excluded');

        require(!_isExcluded[account], "$MEE6: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        ...
        require(_isExcluded[account], "$MEE6: Account is already included");
