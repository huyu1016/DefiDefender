...
contract ObamaDAO is ERC721Enum, Ownable, Pausable,  ReentrancyGuard {
	...
	constructor() ERC721S("Obama Dao", "ObamaDao"){
	    setBaseURI("");
	}
	...
	function _baseURI() internal view virtual returns (string memory) {
		...
		require(_mintAmount <= 1, "Cant mint more then maxmint" );
