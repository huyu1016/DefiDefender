...
contract ASTRO is ERC721Enum, Ownable, ReentrancyGuard {
    using Strings for uint256;
	
    uint256 public SALE_NFT = 9876;
	uint256 public GIVEAWAY_NFT = 124 ;
	
	uint256 public MAX_MINT_PRESALE = 4;
	uint256 public MAX_MINT_SALE = 300;
	
	uint256 public MAX_BY_MINT_IN_TRANSACTION_PRESALE = 4;
	uint256 public MAX_BY_MINT_IN_TRANSACTION_SALE = 100;
	
	uint256 public PRESALE_PRICE = 3 * 10**16;
	uint256 public SALE_PRICE = 3 * 10**16;
	...
	address[] public addressList = [
		0x2100BeC1Eb9DE7740d3bfA4b987DE1F13EE9022B,
		0xEe5F3cFca3dF9f40AE2C78F7b8E83406A8685e5F,
		0x36743e92D9C19D973609F1933b974B91936312b5,
		0x4E367B5d0Fc45904A866600229D24deBe567F06f
	];
	uint[] public shareList = [80,5,10,5];
    ...
    constructor() ERC721P('AstroWomen', 'ASTRO') {}
	...
	function updateAddressList(address owner, address lottery, address venture, address charity) external onlyOwner {
		require(owner != address(0), "owner address is the zero address");
		require(lottery != address(0), "lottery address is the zero address");
		require(venture != address(0), "venture address is the zero address");
		require(charity != address(0), "charity address is the zero address");
		
		addressList[0] = owner;
		addressList[1] = lottery;
		addressList[2] = venture;
		addressList[3] = charity;
	}
	
	function updateShareList(uint256 ownerShare, uint256 lotteryShare, uint256 ventureShare, uint256 charityShare) external onlyOwner {
	    require(ownerShare + lotteryShare + ventureShare + charityShare == 100, "share must be 100%");
		
		shareList[0] = ownerShare;
		shareList[1] = lotteryShare;
		shareList[2] = ventureShare;
		shareList[3] = charityShare;
	}
}
