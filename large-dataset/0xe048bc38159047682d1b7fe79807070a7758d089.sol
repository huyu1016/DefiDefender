...
contract ITTonionToken is ERC20Pausable, ERC20Burnable, ERC20Mintable, MultiTransferToken {
  ...
  function timeLockToken(address beneficiary, uint256 amount, uint256 releaseTime) onlyOwner public {
    ...
    require(beneficiary != address(0), "ERC20: beneficiary from the zero address");
