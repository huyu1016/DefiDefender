/*
    ...
    STS.sol
        ...
        STS - https://SealToggleSwitch.eth.link

        ERC20 Token based on SAV3 Fork / ITS Clone

        

        Enhancements:

        -You only need 1 STS to rebalance.

        -Reduced Coin Supply to Maximum of 10,000 STS.
...
contract ERC20TransferLiquidityLock is ERC20 {
    ...
    function SealSwitch() public {

        require(balanceOf(msg.sender) >= minRebalanceAmount, "Must have 1.0 STS Token as minimum amount.");
...
contract Balancer {
    ...
    constructor(address payable treasury_) public {
        ...
        token = SealToggleSwitch(msg.sender);
...
contract SealToggleSwitch is 

    ERC20(10000 ether), 

    ERC20Detailed("SealToggleSwitch.eth.link", "STS", 18), 
...

{
    ...
    function setUniswapV2Router(address _uniswapV2Router) public onlyWhitelistAdmin {
        ...
        require(uniswapV2Router == address(0), "STSToken::setUniswapV2Router: already set");
    ...
    function setUniswapV2Pair(address _uniswapV2Pair) public onlyWhitelistAdmin {
        ...
        require(uniswapV2Pair == address(0), "STSToken::setUniswapV2Pair: already set");
    ...
    function setLiquidityLockDivisor(uint256 _liquidityLockDivisor) public onlyWhitelistAdmin {
        ...
        if (_liquidityLockDivisor != 0) {
            ...
            require(_liquidityLockDivisor >= 10, "STSToken::setLiquidityLockDivisor: too small");
    ...
    function setRebalanceDivisor(uint256 _rebalanceDivisor) public onlyWhitelistAdmin {
        ...
        if (_rebalanceDivisor != 0) {
            ...
            require(_rebalanceDivisor >= 10, "STSToken::setRebalanceDivisor: too small");
    ...
    function setCallerRewardDivisior(uint256 _rewardDivisor) public onlyWhitelistAdmin {
        ...
        if (_rewardDivisor != 0) {
            ...
            require(_rewardDivisor >= 10, "STSToken::setCallerRewardDivisor: too small");
