...
// File: contracts/TheMetaBullNFT.sol
...
contract MetaBullsClubNFT is ERC721Enumerable, Ownable {
    using Strings for uint256;

    string public baseURI;
    string public baseExtension = ".json";
    uint256 public cost = 0.24 ether;
    uint256 public presaleCost = 0.17 ether;
