...
contract PGHToken is StandardToken, SafeMath {

 

    // metadata

    string  public constant name = "PGH";

    string  public constant symbol = "PGH";
    ...
    function PGHToken(address _ethFundDeposit, uint256 _currentSupply) {
        ...
        totalSupply = formatDecimals(500);   
