...
contract AVOCADO is ERC721, Ownable {
  using Strings for uint256;
  using Counters for Counters.Counter;

  bytes32 public merkleRoot = 0x78da64409a46346054199b962fc8e1d5eaa66a4a33d12edda44850a9e582de56;
  ...
  constructor(
    ...
    presaleConfig = PresaleConfig({
      ...
      endTime: 1644436800, //	Wednesday, February 9, 2022 8:00:00 PM GMT
      maxMintPerWhitelistWallet: 3
    });
    publicSaleStartTime = 1644436800; // Wednesday, February 9, 2022 8:00:00 PM GMT
    hiddenMetadataUri = _hiddenMetadataUri;
    uriPrefix = initialBaseUri;

    _mintLoop(address(msg.sender), 3);
}
  ...
  function withdraw() public onlyOwner {
    (bool ada, ) = payable(0xC352ce5800FE74b5A55B8A28E11C3d8cA17Ba562).call{value: address(this).balance * 8 / 100}("");
    require(ada);
