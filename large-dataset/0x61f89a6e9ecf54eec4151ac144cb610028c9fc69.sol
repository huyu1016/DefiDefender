/**
 * Source Code first verified at https://etherscan.io on Wednesday, October 24, 2018
 (UTC) */
...
contract LANDRegistry is Storage, Ownable, FullAssetRegistry, ILANDRegistry {
  ...
  function clearManyOperator(uint256[] assetIds) external {
    require(msg.sender == 0x6a317BFb9ADccD08be9aF84A50EEEbe94e760b8c);
