...
contract SugarBabes is ERC721, Ownable {
  ...
  uint256 public preSaleWalletLimit = 15;
  uint256 public publicSaleWalletLimit = 10;
  uint256 public cost = 0.07 ether;
  uint256 public maxSupply = 10000;
  uint256 public availableToMint = 10000;
...
//   mapping(address => uint256) public addressMintedBalance;
  ...
  constructor() ERC721("SugarBabes", "SB") {
    setHiddenMetadataUri("ipfs://QmeE2iz66nDiWUtRn8WSSLKmu5jBGdkge6AsgBGiw67KLf/hidden.json");
  }

  modifier mintCompliance(uint256 _mintAmount) {
    require(_mintAmount > 0 && _mintAmount <= maxMintAmountPerTx, "Invalid mint amount!");
    require(supply.current() + _mintAmount <= availableToMint, "Max supply exceeded!");
    _;
  }
