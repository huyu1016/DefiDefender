...
contract MetaNightClub is ERC721Enumerable, Ownable {
    ...
    constructor() ERC721("MetaNightClub", "MNCLUB") {
    ...
    function publicSaleMint(uint numberOfTokens) public payable {
        ...
        require(totalSupply() + numberOfTokens <= MAX_TOKENS, "Purchase would exceed max supply of total tokens");
    ...
    function privateSaleMint(uint numberOfTokens) public payable {
        require(privateSaleIsActive, "Private sale must be active to mint NFTs");
        require(numberOfTokens <= maxTokenPurchase, "Exceeded the max token purchase");
    ...
    //in case eth makes a surprise
    function changePublicPrice(uint256 price) public onlyOwner {
    ...
    function changePrivatePrice(uint256 price) public onlyOwner {
