...
// File: contracts/crck.sol

//SPDX-License-Identifier: MIT
pragma solidity ^0.8.0;

contract CRCK is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    string public baseURI = "ipfs://QmUM9su76wwZyq2uJ6H4GT8k5yKGxCNDeJtY2QQYZc9knA/";
    string private _name = "Crazy Rich Crypto Kids";
    string private _symbol = "CRCK"; 
    ...
    function claim(uint256 _batchCount) payable public {//Will add in getMintTime check using block.timestamp here tomorrow
        ...
        require(_batchCount > 0 && _batchCount <= maxBatch, "Maximum bfrom_keyatch exceeded");
