...
///////////////////
    ...
    uint16 public constant version = 2100;
...
///////////////////
    ...
    event TokenAlive(address sender);
...
// File: contracts\\assettoken\\DividendAssetToken.sol
...
/** @title Dividend AssetToken. Inherits Basic functionality, controller calls for e.g. receiver verification and extends Dividend functionality. */
...
///////////////////
    ...
    function recycleDividend(uint256 _dividendIndex) public onlyOwner {
...
// File: contracts\\assettoken\\EquityAssetToken.sol
...
// File: contracts\\assettoken\\DividendEquityAssetToken.sol
...
/** @title Dividend Equity AssetToken. A DividendAssetToken with CapitalControl feature */

contract DividendEquityAssetToken is DividendAssetToken, FeatureCapitalControlWithForcedTransferFrom
