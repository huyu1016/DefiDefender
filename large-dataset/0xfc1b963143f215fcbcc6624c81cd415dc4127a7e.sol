...
contract BBFinanceToken is StandardToken, SafeMath {
 
    // metadata
    string  public constant name = "BB Finace Coin";
    ...
    uint256 public tokenExchangeRate = 100000;             // 100000 BBFinanceToken 兑换 1 ETH
