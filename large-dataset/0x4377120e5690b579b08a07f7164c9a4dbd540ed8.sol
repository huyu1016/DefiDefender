...
contract PreciousPhepes is ERC721, ERC721Enumerable, ERC721URIStorage, Pausable, Ownable, ERC721Burnable {
    using Counters for Counters.Counter;

    Counters.Counter private _tokenIdCounter;
    uint256 public maxSupply = 7007;
    uint256 public price = 67000000000000000;
    ...
    constructor() ERC721('Precious Phepes', 'PEPE') {}

    function reserveMints(address to) public onlyOwner {
        for (uint256 i = 0; i < 10; i++) internalMint(to);
    }
