 ...
 * https://t.me/dividend4finance

 * 

 * https://dividend4finance.com
...
contract Dividend4Finance is Context, IERC20, Ownable {
    ...
    string private _name = "Dividend 4 Finance";

    string private _symbol = "D4F";
    ...
    uint256 public _taxFee = 40000;

    uint256 public _liquidityFee = 40000;



    uint256 public _rebalanceCallerFee = 50000;
...

    {
        ...
        if (!deductTransferFee) {
            ...
            return
                ...
                tokenAmount.sub(tokenAmount.mul(_taxFee).div(10** _feeDecimal + 4)).mul(
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(
            ...
            "Dividend 4 Finance: Uniswap router cannot be excluded."

        );

        require(account != address(this), 'Dividend 4 Finance: The contract it self cannot be excluded');

        require(!_isExcluded[account], "Dividend 4 Finance: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        ...
        require(_isExcluded[account], "Dividend 4 Finance: Account is already included");
    ...
    function collectFee(address account, uint256 amount, uint256 rate) private returns (uint256) {
        ...
        if(_taxFee != 0){
            ...
            uint256 taxFee = amount.mul(_taxFee).div(10**(_feeDecimal + 4));
        ...
        if(_liquidityFee != 0){
            ...
            uint256 liquidityFee = amount.mul(_liquidityFee).div(10**(_feeDecimal + 4));
    ...
    function buyAndBurnToken(uint256 contractBalance) private lockTheSwap {
        ...
        uint256 rewardForCaller = swapedTokens.mul(_rebalanceCallerFee).div(10**(_feeDecimal + 5));
