...
contract TestPresale is Ownable {
    ...
    IERC20 public testToken = IERC20(0x67D94Da1F10861174926681984DBCb4c97EA25Dd);
    ...
    function changeToOnlyWhitelist() public onlyOwner {
    ...
    receive() payable external presaleHasStarted {
        ...
        testToken.transfer(msg.sender, dokiAmount);
