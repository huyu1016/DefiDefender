...
contract LynchpinPrivateICO is Ownable(0xcFe3bD71c2C4E4a9eE0B7d8FD6618e9306102142)

{
    ...
    uint256 LOCK_PERIOD_START    = 1596931200;    // Sunday, August 9, 2020 12:00:00 AM         start time

    uint256 LOCK_PERIOD_9_MONTH  = 1620518400;    // Sunday, May 9, 2021 12:00:00 AM       9th month done

    uint256 LOCK_PERIOD_10_MONTH = 1623196800;    // Wednesday, June 9, 2021 12:00:00 AM        10th  month done

    uint256 LOCK_PERIOD_11_MONTH = 1625788800;    // Friday, July 9, 2021 12:00:00 AM         11th month done

    uint256 LOCK_PERIOD_END      = 1628467200;    // Monday, August 9, 2021 12:00:00 AM         12th month done - lock-in period ends
