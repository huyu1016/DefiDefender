...
contract AceDapp is Ownable{
    ...
    uint8 constant internal entryFee_ = 30; //Includes the dev fee & the money alloted for the daily fixed interest. 24% is the actual fee charged for buy.
    ...
    uint8 constant internal DevFee_ = 20; //Actual dev fee is only 1.5%. This value will be divided by 10 and used. Since we cannot use a decimal here, a round number is used.
