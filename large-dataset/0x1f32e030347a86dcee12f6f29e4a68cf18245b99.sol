...
contract HZLTESTecurityToken is StandardToken, SafeMath {

 

    // metadata

    string  public constant name = "HZLTESTOKEN";

    string  public constant symbol = "HZL";
