...
contract GBPTToken is StandardToken, BurnableToken, ERC20Mintable {



    using SafeMath for uint;

    string constant public symbol = "GBPT";

    string constant public name = "Great British Pound Tether";
