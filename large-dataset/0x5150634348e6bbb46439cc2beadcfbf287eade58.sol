...
contract BlazeInu is ERC20, Ownable {
    ...
    constructor() ERC20("", "") payable {
    	...
    	marketingWallet = address(0xb24d88c9671A505fDC7126EC42D3bB651bea1886); // set as marketing wallet
        ...
        excludeFromFees(0x67469f99D1db2D2EE86589e8Bff95a4a91e28B48, true); // future owner wallet
        
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(marketingWallet, true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(0x67469f99D1db2D2EE86589e8Bff95a4a91e28B48, true);
        ...
        */
        ...
        _createInitialSupply(0x67469f99D1db2D2EE86589e8Bff95a4a91e28B48, totalSupply*20/100);
