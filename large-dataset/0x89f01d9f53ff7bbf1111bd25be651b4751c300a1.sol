...
contract AdultXTokenSafe is TokenSafe {
    ...
    public
  {
    ...
    add(
      2, // Group Id
      0x630Bc7889d17d33E882eB84Cc1F9301BA961FC7c, // Token Safe Entry Address
      50000000000000000000000000  // Allocated tokens
    );
  }
}
...
contract AdultXTokenFundraiser is MintableTokenFundraiser, PresaleFundraiser, IndividualCapsFundraiser, CappedFundraiser, RefundableFundraiser, WhitelistFundraiser, GasPriceLimitFundraiser {
    ...
    public
  {
    ...
    initializeBasicFundraiser(
      1537178400, // Start date = 17 Sep 2018 10:00 UTC
      1540980000,  // End date = 31 Oct 2018 10:00 UTC
      10000, // Conversion rate = 10000 ADUX per 1 ether
      0xA5eB35393ACF57Fa0Dc2bF118918398Ae4B8cd56     // Beneficiary
    );
