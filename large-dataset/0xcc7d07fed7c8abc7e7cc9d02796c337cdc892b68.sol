...
contract SneakerPunkzV2 is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("SneakerPunkzV2", "SNEAKZ") {
    setHiddenMetadataUri("ipfs://QmYaj1XnAsT6GiPVdymqLKHsRj3Cohyi5F3q19yxm2WHmX/hidden_metadata.json");
  }
