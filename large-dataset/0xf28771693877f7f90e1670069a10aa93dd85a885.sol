...
contract Aotaverse is ERC721, Ownable, ReentrancyGuard {
    ...
    bytes32 public merkleRoot = 0x450a513e792e43fa592f74169e2a79a1ce5a08272c26f7f494e27e2d56d18d7d;
    ...
    address private constant withdrawTo = 0xFe5c087fD87891cA23AB98904d65A92D15A07D45;

    constructor() ERC721("Aotaverse", "AOTA") ReentrancyGuard() {
        setHiddenMetadataUri("ipfs://Qmar3nffS1aMs1nsTg7J225WKVkenqfwYNLPF3MEEbUbxR/blind.json"); 
        supply.increment();
    ...
    function mintForAddress(uint256 _mintAmount, address _receiver) external onlyOwner nonReentrant { 
        require(mode == 4, "Mode is not post-sale");
    ...
    function togglemode() external onlyOwner { 
        if(mode == 1) {
            mode = 2;
            cost = 0.15 ether;
            merkleRoot = 0x9cda0a83c7fb86bd9c2b6808e91d8320854e7951a44376f6351087a304d4851b;
        }
        else if(mode == 2) {
            mode = 3;
            cost = 0.2 ether;
