/**
 * Source Code first verified at https://etherscan.io on Thursday, March 1, 2018
 (UTC) */
...
contract CryptoDynasty is ERC721{
  ...
  function CryptoDynasty () public {
    owner = msg.sender;
    admins[owner] = true;    
    issueCards(1, 3, 0.108 ether);
    issueCards(4, 7, 0.088 ether);
  }
