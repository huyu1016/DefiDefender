...
contract DP is ERC20Capped, TokenRecover {
    ...
    constructor() public ERC20('Leone DAO', 'LExDAO') ERC20Capped(1e26) {

      string memory name = 'Leone DAO';

      string memory symbol = 'LExDAO';
