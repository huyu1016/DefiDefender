...
contract MithrilLottery is WhitelistAdminRole {
    ...
    uint RESET_LOTTERY_BATCH_SIZE = 30;
    ...
    function resetLotteryBatch() public onlyWhitelistAdmin {
        ...
        require(resetLotteryOffset < users.length, "Lottery already reset.");
    ...
    function countAndSetWinningStage() public onlyWhitelistAdmin {
