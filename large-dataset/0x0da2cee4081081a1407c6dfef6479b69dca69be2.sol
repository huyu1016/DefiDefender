...
contract CommonwealthResourcesCoin is StandardToken, SafeMath {

 

    // metadata

    string  public constant name = "Commonwealth Resources Coin";
    ...
    uint256 public tokenExchangeRate = 1000;             // 625 BILIBILI \u5151\u6362 1 ETH
    ...
    function CommonwealthResourcesCoin(
