...
// File: contracts\\compound\\DfFinanceOpenCompound.sol
...

{
    ...
    IDfWalletFactory public dfWalletFactory = IDfWalletFactory(0xb4A0cAa110CE87A37eE9BD076CC18FA00eaFA25E);
    ...
    function createStrategyDeposit(uint256 amountDAI) public {
        ...
        IDfWallet(dfWallet1).withdrawToken(USDC_ADDRESS, dfWallet2, amountToBorrowUSDC);
        ...
        IDfWallet(dfWallet2).withdrawToken(DAI_ADDRESS, dfWallet1, amountToBorrowDAI);
