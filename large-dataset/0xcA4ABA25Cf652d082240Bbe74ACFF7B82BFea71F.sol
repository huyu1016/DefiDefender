...
// File: contracts/Chibi_Ichiban_Unflat.sol
...
contract Chibi_Ichiban is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Chibi Ichiban VV", "TES") {
    setHiddenMetadataUri("ipfs://QmVhutM73hQEWYVCXk1j4oH4ugiMnrGVkNEZfLkYvEHN8g/Hidden.json");
  }
