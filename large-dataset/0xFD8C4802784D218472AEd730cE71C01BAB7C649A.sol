...
/**
 * @title Pet Batz Doodles contract
 * @author Pet Batz Doodles Blockchain Developer
 * @dev Extends ERC721 Non-Fungible Token Standard basic implementation
 */
contract PetBatzDoodles is ERC721Enumerable, Ownable {
    using Strings for uint256;
    ...
    // Costs ====================================
    uint256 public publicSaleCost = 0.049 ether;

    // Sale dates ===============================
    uint public publicSaleStartTimestamp = 1645707600;

    // Count values =============================
    uint256 public MAX_ITEMS = 10000;
    uint256 public _mintedItems = 0;
    uint256 public maxMintAmount = 10; // Max items per tx
    uint256 public maxMintAmntPerWal = 10; // Max items per wallet
    ...
    function publicMint() public payable {
        ...
        require(_mintedItems.add(_mintAmount) <= MAX_ITEMS, "exceeded max supply of Pet Batz Doodles");
        require(_mintAmount <= maxMintAmount, "max mint amount per tx is 10");
        require(soldWallets[msg.sender] + _mintAmount <= maxMintAmntPerWal, "Max mint amount per wallet is 10");
