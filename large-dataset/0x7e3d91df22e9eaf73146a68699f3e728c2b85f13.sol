...
contract GovernorAlpha {
    ...
    /// @notice supply of the governor token
    ...
    /// @notice The address of the NFT Protocol Timelock

    TimelockInterface public timelock;



    /// @notice The address of the NFT governance token
    ...
    constructor(address nft_, uint supply_) public {
...
/// @notice the factory for governances
