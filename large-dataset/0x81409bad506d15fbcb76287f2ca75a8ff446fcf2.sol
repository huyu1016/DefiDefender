...
contract CHEST is Context, IERC20, Ownable {
    ...
    string private _name = "Chest Protocol";

    string private _symbol = "$CHEST";
    ...
    uint256 internal _tokenTotal = 900e9;
    ...
    uint256 public _rebalanceCallerFee = 700;
    ...
    uint256 public minTokensBeforeSwap = 1;

    uint256 public minEthBeforeSwap = 1;
    ...
    uint256 public rebalanceInterval = 120 minutes;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'CHEST: The contract it self cannot be excluded');

        require(!_isExcluded[account], "CHEST: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        ...
        require(_isExcluded[account], "CHEST: Account is already included");
    ...
    function _transfer(
        ...
        require(now > liquidityAddedAt + 6 minutes  || amount <= 15000e18, "You cannot transfer more than 150 tokens.");
