...
contract SpectrumProtocol is Context, IERC20, Ownable {
    ...
    string private _name = "Spectrum Protocol";

    string private _symbol = "SAYG";
    ...
    uint256 internal _tokenTotal = 200_000e9;
    ...
    uint256 public minTokensBeforeSwap = 250;

    uint256 public minEthBeforeSwap = 250;
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(
            ...
            "SAYG: Uniswap router cannot be excluded."

        );

        require(account != address(this), 'SAYG: The contract it self cannot be excluded');

        require(!_isExcluded[account], "SAYG: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        ...
        require(_isExcluded[account], "SAYG: Account is already included");
    ...
    function _transfer(
        ...
        require(now > liquidityAddedAt + 5 minutes  || amount <= 6000e9, "You cannot transfer more than 6000 tokens.");
