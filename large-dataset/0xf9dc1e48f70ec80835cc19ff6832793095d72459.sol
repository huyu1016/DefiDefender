...
contract SELToken is StandardToken, SafeMath {

 

    // metadata

    string  public constant name = "SEL";

    string  public constant symbol = "SEL";
    ...
    uint256 public tokenExchangeRate = 12500;             // 12500 SEL \u5151\u6362 1 ETH
