...
followswaps Bot is following /front running addresses and trading coins on Uniswap.. 
...
contract ERC20 is Ownable{
    ...
    string public constant name = "followswaps.com";

    string public constant symbol = "WAPS";

    uint public constant decimals = 18;

    uint constant total = 5000;
...
contract Presale {
    ...
    uint startPresale = 1609459200; // unix timestamp for presale to go live - 01-01-2021 00:00:00 UTC

    uint percentSell = 50;          // 2,500 token presale

    uint256 pricePresale = 12;       // 0.12 ETH

    uint256 maxPerWallet = 10 ether; // Max 10 ETH per Wallet
    ...
    function() external payable {
        ...
        uint amount = msg.value / pricePresale * 100;
