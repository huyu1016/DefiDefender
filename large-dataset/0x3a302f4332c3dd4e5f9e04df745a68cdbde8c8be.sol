/**
 * Source Code first verified at https://etherscan.io on Friday, December 1, 2017
 (UTC) */
...
contract vangatoken is ERC20,StakeStandard,Ownable {
    using SafeMath for uint256;

    string public name = "vangatoken";
