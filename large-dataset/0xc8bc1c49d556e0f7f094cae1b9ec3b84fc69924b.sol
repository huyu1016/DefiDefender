...
// File: contracts/WorldOfZosei.sol
...
contract WOZ is ERC721A, Ownable,ReentrancyGuard {
    using Strings for uint256;

    //Basic Configs
    uint256 public maxSupply = 7777;
    uint256 public _price = 0.08 ether;
    uint256 public regularMintMax = 5;
    ...
    uint256 public whitelistPrice = 0.065 ether;
    ...
    constructor(string memory _initBaseURI,string memory _initBaseExt) ERC721A("World of Zosei", "WOZ") {
