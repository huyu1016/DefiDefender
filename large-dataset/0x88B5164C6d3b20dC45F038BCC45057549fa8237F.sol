...
contract MetaApeFightClub is ERC721, Ownable {
  using Strings for uint256;
  ...
  constructor() ERC721("Meta Ape Fight Club", "MAFC") {
    setHiddenMetadataUri("https://ipfs.io/ipfs/QmaaffBrqefmNh1oGYuLqzFUT2AZhwvMJDDb2KPtdbST5w/hidden.json");
  }
