...
contract YFHIT is Ownable {
  ...
  string public constant name = "Yearn Finance HIT";

  string public constant symbol = "YFHIT";

  uint256 public constant decimals = 18;

  // the supply will not exceed 30,000 YFHIT

  uint256 private constant _maximumSupply = 30000 * 10 ** decimals;

  uint256 private constant _maximumPresaleBurnAmount = 12000 * 10 ** decimals;
