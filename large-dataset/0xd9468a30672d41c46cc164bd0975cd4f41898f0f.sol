...
contract TheRoosterHood is ERC721Enumerable, Ownable
{
    ...
    function tokenURI(uint256 tokenId) public view override returns (string memory) {
        ...
        if(bytes(base).length > 0){
            return reveal ? string(abi.encodePacked(base, tokenId.toString(), ".json")) : string(abi.encodePacked("https://gateway.pinata.cloud/ipfs/QmcCZM7ra5jecqkCNfdVevGY2aPwZEHKSX7bwDFT95hrhR"));
        }
        else 
        return "";
    }
    ...
    function contractURI() public view returns (string memory) {
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "The Rooster Hood", "description": "THE RoosterHOOD is a collection of 9494 NFT, based on Broosters trials and tribulations. Putting community at the center of the collection, no yacht party but long term rewards and support.", "seller_fee_basis_points": 500, "fee_recipient": "0x76fcCf79205F18D579834d602a0a6b15eEF5C80a"}'))));
