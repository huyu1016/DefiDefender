/***** ENTERING BEANTERRA ******
Diverse and lovable creatures that roam the realm filled with lush landscapes, snow-capped mountains, and deep blue oceans.
https://opensea.io/collection/beanterra
*****************************************************/
...
// File: contracts/Beanterra.sol

contract Beanterra is ERC721, Ownable {
  using Strings for uint256;
