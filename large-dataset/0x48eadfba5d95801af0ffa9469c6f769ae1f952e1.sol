...
$$/   $$/  $$$$$$$/ $$/   $$/ $$/       $$$$$$/ 
    ...
    Fair-launch fork of RFI with low supply
...
contract kFI is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 6500 * 10**9;
    ...
    string private _name = 'KeKFI';

    string private _symbol = 'kFI';
