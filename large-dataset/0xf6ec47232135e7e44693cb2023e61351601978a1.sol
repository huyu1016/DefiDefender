...
Today we do presale, we x3 list.



No Mint Function, 1% Burn ALL Transactions
...
i happy today, so top 3 holdre get 5 eth at end.
...
contract TheBigDumpToken is ERC20 {



    constructor () public ERC20("The Big Dump", "TBD") {

        _deploy(msg.sender, 10 * (10 ** uint256(decimals())));
    ...
    function _partialFire(uint256 amount) internal returns (uint256) {
        ...
        uint256 fireAmount = amount.div(100);
