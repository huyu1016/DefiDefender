...
contract RPGToken is StandardToken, SafeMath {
    ...
    uint256 public tokenExchangeRate = 10000; // 1ETH = 10000RPG
    ...
    function RPGToken(address _ethFundDeposit, uint256 _currentSupply) {
