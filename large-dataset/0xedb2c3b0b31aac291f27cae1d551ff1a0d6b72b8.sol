...
// File: contracts/BigDrunkBabyClub.sol
...
/// Congratulations! You have discovered the first step of the Big Drunk Baby Club Enigma.

/// The first person to solve the puzzle completely will receive 50 Ethereum as a reward.
/// Throughout our project we have been hiding clues to solve the Big Drunk Baby Club Enigma.
/// The final reward may increase depending on the popularity of our project.

/// For this first step you will have to send an e-mail with the subject: Big Drunk Baby Club Enigma to the address below...
/// Only small problem, it's up to you to discover the missing letters or numbers at the address in question.


///        _ _ _ _ _ _ 3 _ @outlook.com

/// Hint: Be patient, don't take your eyes off the bird as it flies away.

///This first step is the simplest of all and is only meant to test your ability to solve our different puzzles.
///The second step will be sent to you directly by e-mail in response to the e-mail you sent with the subject line: Big Drunk Baby Club Enigma.
///It will be necessary for you to succeed in the first step to access the second.

/// Warning: The first step is limited in time. We will keep you informed about the end date of this step via our Social Networks.
/// Good luck! And see you at the second step.
...
contract BigDrunkBabyClub is ERC721Enumerable, PaymentSplitter, Ownable, ReentrancyGuard {
    ...
    uint public pricePresale = 0.04 ether;
    ...
    address[] private _team = [
        0x8E2E416F552B0db0069527E9BaCA8819371De066
    ];
    ...
    constructor(string memory _theBaseURI, string memory _notRevealedURI, bytes32 _merkleRoot) ERC721("Big Drunk Baby", "BDBC") PaymentSplitter(_team, _teamShares) {
