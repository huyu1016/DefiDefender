...
contract Cryptopumps is ERC721, Ownable {
    using Strings for uint256;
    using Counters for Counters.Counter;

    uint256 public NFT_MAX_SUPPLY = 8888;
    uint256 public NFT_PRICE = 0.05 ether;
    uint256 public NFTS_PER_MINT = 10;
    string private _contractURI;
    string private _tokenBaseURI;
    string public _mysteryURI;
    uint256 public currentBalance = address(this).balance;
    address private withdrawAddress = 0xcA1Aa204A9200e2CbB49AF9bc66b84da0f298132;
    ...
    constructor() ERC721("CRYPTOPUMPS", "PUMPS") {
        _tokenBaseURI = "ipfs://QmZKcba9WEWuUh7JUsKsJX16MhcFMdH1qi6ja8KrtXoJia/";
        _mysteryURI = "ipfs://QmcPU8CBoYQbdGo3dSRTk5BGbPARcts39WKthiBXaH1PK9/";
    }
    ...
    function setNftsPerMint(uint quantity) public onlyOwner {
