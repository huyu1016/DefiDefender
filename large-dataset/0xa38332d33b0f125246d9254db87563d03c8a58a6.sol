/**
  ...
  / ____/___ _______________  / /_/ ____/________ _      ______/ /________ _/ /__ 

 / /   / __ `/ ___/ ___/ __ \\/ __/ /   / ___/ __ \\ | /| / / __  / ___/ __ `/ / _ 

/ /___/ /_/ / /  / /  / /_/ / /_/ /___/ /  / /_/ / |/ |/ / /_/ (__  ) /_/ / /  __/

\\____/\\__,_/_/  /_/   \\____/\\__/\\____/_/   \\____/|__/|__/\\__,_/____/\\__,_/_/\\___/ 
...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    // How many token units a minter gets per wei.
     ...
     * @param rate Number of token units a minter gets per wei
     ...
     * of 2300, which is not enough to call mintTokens. Consider calling

     * mintTokens directly when purchasing tokens from a contract.

     */

    function () external payable {

        mintTokens(_msgSender());
     ...
     * @return the number of token units a minter gets per wei.
    ...
    function mintTokens(address beneficiary) public nonReentrant payable {
...
contract IncreasingPriceCrowdsale is TimedCrowdsale {
     ...
     * @param finalRate Number of tokens a minter gets per wei at the end of the crowdsale
     ...
     * @return The number of tokens _weiAmount wei will mint at present time
...
contract TreasuryCrowdsale is FinalizableCrowdsale {
    ...
    // mint treasury supply a single time after finalization (~3% unlocked, ~20% locked for 2 years)
    ...
    function _finalization() internal {
        ...
        treasuryTimelock = new TokenTimelock(
            ...
            block.timestamp.add(60 * 60 * 24 * 365 * 2), // 2 years
...
// File: contracts/CarrotCrowdsale.sol
...

{
    ...
    uint256 private _finalRate = 1e5;
