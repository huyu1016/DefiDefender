...
contract BMXDToken is ERC20Pausable, ERC20Burnable, ERC20Mintable, MultiTransferToken {

  string public constant name = "Blue Mountain eXchange-DeFi";

  string public constant symbol = "BMX-D";
