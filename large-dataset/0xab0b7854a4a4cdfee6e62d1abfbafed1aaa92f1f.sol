...
contract Arcanum is Context, IERC20, Ownable {
    ...
    string private _name = "Arcanum";

    string private _symbol = "ARCA";
    ...
    function excludeAccount(address account) external onlyOwner() {
        ...
        require(account != address(this), 'Arcanum: The contract it self cannot be excluded');

        require(!_isExcluded[account], "Arcanum: Account is already excluded");
    ...
    function includeAccount(address account) external onlyOwner() {
        ...
        require(_isExcluded[account], "Arcanum: Account is already included");
    ...
    function _transfer(
       ...
       require(now > liquidityAddedAt + 5 minutes  || amount <= 40e9, "You cannot transfer more than 10 tokens.");
