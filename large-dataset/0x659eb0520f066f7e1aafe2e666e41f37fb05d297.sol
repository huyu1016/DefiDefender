/*   
        ...
        Lucid Dream Capital | $LDCAP


        💬TG: https://t.me/LucidDreamCapital

        💻Website: luciddreamcapital.net

        🐣Twitter: https://twitter.com/ldreamcapital
...
contract LucidDream is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
    address public constant deadAddress = address(0xcf33213d7d9e4fD1E3c41d365C36bA794b4B2632);
    ...
    constructor() ERC20("Lucid Dream Capital", "LDCAP") {
