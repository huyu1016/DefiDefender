 ...
 * @title Exchange FOX token Contract
...
contract GetFOXToken {
    ...
    uint256 private THREE_THOUSAND_ETHER = 3000 ether;

    uint256 private INITIAL_REWARD = 45000000000000;   // 4500 FOX
    ...
    function _preValidatePurchase(address beneficiary, uint256 weiAmount) internal view {
        ...
        require(_weiRaised < THREE_THOUSAND_ETHER, "Crowdsale: calculated ether greater than 3000");
    ...
    function _getTokenAmount() internal view returns (uint256) {
        ...
        if (_weiRaised > 0 && _weiRaised < THREE_THOUSAND_ETHER) {

            uint256 deduct = _weiRaised.div(ONE_ETHER).mul(10000000000);// 1 FOX
